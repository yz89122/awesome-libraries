...
- [DMG-CPU-Inside ![GitHub Repo stars](https://img.shields.io/github/stars/furrtek/DMG-CPU-Inside) ![GitHub last commit](https://img.shields.io/github/last-commit/furrtek/DMG-CPU-Inside)](https://github.com/furrtek/DMG-CPU-Inside) - Schematics and annotated overlay for the DMG-CPU-B chip, extracted from die photos.
...
- [Gambatte ![GitHub Repo stars](https://img.shields.io/github/stars/sinamas/gambatte) ![GitHub last commit](https://img.shields.io/github/last-commit/sinamas/gambatte)](https://github.com/sinamas/gambatte) - Cross-platform and accurate emulator.
...
- [SoundSystem ![GitHub Repo stars](https://img.shields.io/github/stars/gb-archive/GBSoundSystem) ![GitHub last commit](https://img.shields.io/github/last-commit/gb-archive/GBSoundSystem)](https://github.com/gb-archive/GBSoundSystem) - A modernized audio driver for GameBoy Tracker (aka the Paragon 5 music player).
