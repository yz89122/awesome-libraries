...
* [Raywenderlich ![GitHub Repo stars](https://img.shields.io/github/stars/raywenderlich/swift-style-guide) ![GitHub last commit](https://img.shields.io/github/last-commit/raywenderlich/swift-style-guide)](https://github.com/raywenderlich/swift-style-guide) - Raywenderlich guide, a must read.
...
* [xcbeautify ![GitHub Repo stars](https://img.shields.io/github/stars/thii/xcbeautify) ![GitHub last commit](https://img.shields.io/github/last-commit/thii/xcbeautify)](https://github.com/thii/xcbeautify) - Little beautifier tool for xcodebuild.
...
* [DKChainableAnimationKit ![GitHub Repo stars](https://img.shields.io/github/stars/Draveness/DKChainableAnimationKit) ![GitHub last commit](https://img.shields.io/github/last-commit/Draveness/DKChainableAnimationKit)](https://github.com/Draveness/DKChainableAnimationKit) - Easy to read and write chainable animations.
...
* [Kinieta ![GitHub Repo stars](https://img.shields.io/github/stars/mmick66/kinieta) ![GitHub last commit](https://img.shields.io/github/last-commit/mmick66/kinieta)](https://github.com/mmick66/kinieta) - An simple Animation Engine for iOS with an Intuitive API and Readable Code.
...
* [SwiftInstagram ![GitHub Repo stars](https://img.shields.io/github/stars/AnderGoig/SwiftInstagram) ![GitHub last commit](https://img.shields.io/github/last-commit/AnderGoig/SwiftInstagram)](https://github.com/AnderGoig/SwiftInstagram) - Instagram API wrapper.
...
* [ARVoxelKit ![GitHub Repo stars](https://img.shields.io/github/stars/VoxxxelAR/ARVoxelKit) ![GitHub last commit](https://img.shields.io/github/last-commit/VoxxxelAR/ARVoxelKit)](https://github.com/VoxxxelAR/ARVoxelKit) - Voxel graphic framework using ARKit.
* [Poly ![GitHub Repo stars](https://img.shields.io/github/stars/piemonte/Poly) ![GitHub last commit](https://img.shields.io/github/last-commit/piemonte/Poly)](https://github.com/piemonte/Poly) - Unofficial Google Poly SDK – explore the world of 3D.

### Authentication
*Easy way to manage auth in your apps.* [back to top](#readme) 

* [Cely ![GitHub Repo stars](https://img.shields.io/github/stars/chaione/Cely) ![GitHub last commit](https://img.shields.io/github/last-commit/chaione/Cely)](https://github.com/chaione/Cely) - A Plug-n-Play login framework.
* [InstagramLogin ![GitHub Repo stars](https://img.shields.io/github/stars/AnderGoig/InstagramLogin) ![GitHub last commit](https://img.shields.io/github/last-commit/AnderGoig/InstagramLogin)](https://github.com/AnderGoig/InstagramLogin) - Simple way to authenticate Instagram accounts.
...
* [PNChart-Swift ![GitHub Repo stars](https://img.shields.io/github/stars/kevinzhow/PNChart-Swift) ![GitHub last commit](https://img.shields.io/github/last-commit/kevinzhow/PNChart-Swift)](https://github.com/kevinzhow/PNChart-Swift) - A simple and beautiful chart lib with animation.
...
* [SwiftCharts ![GitHub Repo stars](https://img.shields.io/github/stars/i-schuetz/SwiftCharts) ![GitHub last commit](https://img.shields.io/github/last-commit/i-schuetz/SwiftCharts)](https://github.com/i-schuetz/SwiftCharts) - Highly customizable charts for iOS.
...
* [HexColor ![GitHub Repo stars](https://img.shields.io/github/stars/artman/HexColor) ![GitHub last commit](https://img.shields.io/github/last-commit/artman/HexColor)](https://github.com/artman/HexColor) - Define UIColors as Hex integers.
...
* [CommandLine ![GitHub Repo stars](https://img.shields.io/github/stars/jatoben/CommandLine) ![GitHub last commit](https://img.shields.io/github/last-commit/jatoben/CommandLine)](https://github.com/jatoben/CommandLine) :penguin: - Library for creating command-line interfaces.
...
* [Kommander ![GitHub Repo stars](https://img.shields.io/github/stars/intelygenz/Kommander-iOS) ![GitHub last commit](https://img.shields.io/github/last-commit/intelygenz/Kommander-iOS)](https://github.com/intelygenz/Kommander-iOS) - Manage the task execution in different threads through Kommands.
...
* [Money ![GitHub Repo stars](https://img.shields.io/github/stars/danthorpe/Money) ![GitHub last commit](https://img.shields.io/github/last-commit/danthorpe/Money)](https://github.com/danthorpe/Money) - Currency formatter.
...
* [AlecrimCoreData ![GitHub Repo stars](https://img.shields.io/github/stars/Alecrim/AlecrimCoreData) ![GitHub last commit](https://img.shields.io/github/last-commit/Alecrim/AlecrimCoreData)](https://github.com/Alecrim/AlecrimCoreData) - Simple Core Data wrapper library.
...
* [Freddy ![GitHub Repo stars](https://img.shields.io/github/stars/bignerdranch/Freddy) ![GitHub last commit](https://img.shields.io/github/last-commit/bignerdranch/Freddy)](https://github.com/bignerdranch/Freddy) - A reusable framework for parsing JSON.
* [Gloss ![GitHub Repo stars](https://img.shields.io/github/stars/hkellaway/Gloss) ![GitHub last commit](https://img.shields.io/github/last-commit/hkellaway/Gloss)](https://github.com/hkellaway/Gloss) :penguin: - Shiny JSON parsing library.
...
* [Unbox ![GitHub Repo stars](https://img.shields.io/github/stars/JohnSundell/Unbox) ![GitHub last commit](https://img.shields.io/github/last-commit/JohnSundell/Unbox)](https://github.com/JohnSundell/Unbox) - The easy to use JSON decoder.
...
* [UserDefaultsStore ![GitHub Repo stars](https://img.shields.io/github/stars/omaralbeik/UserDefaultsStore) ![GitHub last commit](https://img.shields.io/github/last-commit/omaralbeik/UserDefaultsStore)](https://github.com/omaralbeik/UserDefaultsStore) - Why not use UserDefaults to store Codable objects 😉.
...
* [MongoKitten ![GitHub Repo stars](https://img.shields.io/github/stars/OpenKitten/MongoKitten) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenKitten/MongoKitten)](https://github.com/OpenKitten/MongoKitten) :penguin: - MongoDB Connector.
...
* [Realm ![GitHub Repo stars](https://img.shields.io/github/stars/realm/realm-cocoa) ![GitHub last commit](https://img.shields.io/github/last-commit/realm/realm-cocoa)](https://github.com/realm/realm-cocoa) - Realm is a mobile database: a replacement for Core Data & SQLite.
* [Realm+JSON ![GitHub Repo stars](https://img.shields.io/github/stars/matthewcheok/Realm-JSON) ![GitHub last commit](https://img.shields.io/github/last-commit/matthewcheok/Realm-JSON)](https://github.com/matthewcheok/Realm-JSON) - A concise Mantle-like way of working with Realm and JSON.
...
* [SourceDocs ![GitHub Repo stars](https://img.shields.io/github/stars/eneko/SourceDocs) ![GitHub last commit](https://img.shields.io/github/last-commit/eneko/SourceDocs)](https://github.com/eneko/SourceDocs/) - Generate Markdown reference documentation that lives with your code.
...
* [BrightFutures ![GitHub Repo stars](https://img.shields.io/github/stars/Thomvis/BrightFutures) ![GitHub last commit](https://img.shields.io/github/last-commit/Thomvis/BrightFutures)](https://github.com/Thomvis/BrightFutures) - Promise and future lib.
...
* [EasyFutures ![GitHub Repo stars](https://img.shields.io/github/stars/DimaMishchenko/EasyFutures) ![GitHub last commit](https://img.shields.io/github/last-commit/DimaMishchenko/EasyFutures)](https://github.com/DimaMishchenko/EasyFutures) - 🔗Futures & Promises. Easy to use. Highly combinable.
...
* [RxReduce ![GitHub Repo stars](https://img.shields.io/github/stars/RxSwiftCommunity/RxReduce) ![GitHub last commit](https://img.shields.io/github/last-commit/RxSwiftCommunity/RxReduce)](https://github.com/RxSwiftCommunity/RxReduce) - Reactive implementation of the state container pattern (like Redux). It is based on the simple concepts of state immutability and unidirectionnal data flow.
...
* [Snail ![GitHub Repo stars](https://img.shields.io/github/stars/UrbanCompass/Snail) ![GitHub last commit](https://img.shields.io/github/last-commit/UrbanCompass/Snail)](https://github.com/UrbanCompass/Snail) - An Observables framework.
...
* [OpenSansSwift ![GitHub Repo stars](https://img.shields.io/github/stars/hemantasapkota/OpenSansSwift) ![GitHub last commit](https://img.shields.io/github/last-commit/hemantasapkota/OpenSansSwift)](https://github.com/hemantasapkota/OpenSansSwift) - OpenSans.
* [SwiftIconFont ![GitHub Repo stars](https://img.shields.io/github/stars/0x73/SwiftIconFont) ![GitHub last commit](https://img.shields.io/github/last-commit/0x73/SwiftIconFont)](https://github.com/0x73/SwiftIconFont) - Fontawesome, Iconic, Ionicons, Octicon ports.
...
* [Vulcan ![GitHub Repo stars](https://img.shields.io/github/stars/jinSasaki/Vulcan) ![GitHub last commit](https://img.shields.io/github/last-commit/jinSasaki/Vulcan)](https://github.com/jinSasaki/Vulcan) - Multi image downloader with priority.
...
* [LayoutKit ![GitHub Repo stars](https://img.shields.io/github/stars/LinkedInAttic/LayoutKit) ![GitHub last commit](https://img.shields.io/github/last-commit/LinkedInAttic/LayoutKit)](https://github.com/LinkedInAttic/LayoutKit) - LayoutKit is a fast view layout library for iOS, macOS, and tvOS.
...
* [QorumLogs ![GitHub Repo stars](https://img.shields.io/github/stars/goktugyil/QorumLogs) ![GitHub last commit](https://img.shields.io/github/last-commit/goktugyil/QorumLogs)](https://github.com/goktugyil/QorumLogs) - Logging Utility for Xcode & Google Docs.
...
* [MapViewPlus ![GitHub Repo stars](https://img.shields.io/github/stars/okhanokbay/MapViewPlus) ![GitHub last commit](https://img.shields.io/github/last-commit/okhanokbay/MapViewPlus)](https://github.com/okhanokbay/MapViewPlus) - Use any custom view as custom callout view for MKMapView with cool animations. Use any image as annotation view.
...
* [Dratini ![GitHub Repo stars](https://img.shields.io/github/stars/kevin0571/Dratini) ![GitHub last commit](https://img.shields.io/github/last-commit/kevin0571/Dratini)](https://github.com/kevin0571/Dratini) - A neat network layer.
...
* [NEKit ![GitHub Repo stars](https://img.shields.io/github/stars/zhuhaow/NEKit) ![GitHub last commit](https://img.shields.io/github/last-commit/zhuhaow/NEKit)](https://github.com/zhuhaow/NEKit) - A toolkit for Network Extension Framework.
* [NetClient ![GitHub Repo stars](https://img.shields.io/github/stars/intelygenz/NetClient-iOS) ![GitHub last commit](https://img.shields.io/github/last-commit/intelygenz/NetClient-iOS)](https://github.com/intelygenz/NetClient-iOS) - Versatile HTTP networking library.
...
* [Ji ![GitHub Repo stars](https://img.shields.io/github/stars/honghaoz/Ji) ![GitHub last commit](https://img.shields.io/github/last-commit/honghaoz/Ji)](https://github.com/honghaoz/Ji) - XML/HTML parser.
...
* [SwiftDSSocket ![GitHub Repo stars](https://img.shields.io/github/stars/csujedihy/SwiftDSSocket) ![GitHub last commit](https://img.shields.io/github/last-commit/csujedihy/SwiftDSSocket)](https://github.com/csujedihy/SwiftDSSocket) - Asynchronous socket framework built atop DispatchSource.
...
* [Corvus ![GitHub Repo stars](https://img.shields.io/github/stars/apodini/corvus) ![GitHub last commit](https://img.shields.io/github/last-commit/apodini/corvus)](https://github.com/apodini/corvus) :penguin: - Web framework to build REST APIs with a declarative syntax.
...
* [Marathon ![GitHub Repo stars](https://img.shields.io/github/stars/JohnSundell/Marathon) ![GitHub last commit](https://img.shields.io/github/last-commit/JohnSundell/Marathon)](https://github.com/JohnSundell/Marathon) - Easy way to create and manage scripts.
...
* [Ambience ![GitHub Repo stars](https://img.shields.io/github/stars/tmergulhao/Ambience) ![GitHub last commit](https://img.shields.io/github/last-commit/tmergulhao/Ambience)](https://github.com/tmergulhao/Ambience) - Brightness aware accessibility theme switching without coding.
...
* [PySwiftyRegex ![GitHub Repo stars](https://img.shields.io/github/stars/cezheng/PySwiftyRegex) ![GitHub last commit](https://img.shields.io/github/last-commit/cezheng/PySwiftyRegex)](https://github.com/cezheng/PySwiftyRegex) - Easily deal with Regex in a Pythonic way.
...
* [Element ![GitHub Repo stars](https://img.shields.io/github/stars/eonist/Element) ![GitHub last commit](https://img.shields.io/github/last-commit/eonist/Element)](https://github.com/eonist/Element) - Programmatic UI framework for macOS.
...
* [Geometry ![GitHub Repo stars](https://img.shields.io/github/stars/artman/Geometry) ![GitHub last commit](https://img.shields.io/github/last-commit/artman/Geometry)](https://github.com/artman/Geometry) - extensions for UIView.
...
* [Hexacon ![GitHub Repo stars](https://img.shields.io/github/stars/gautier-gdx/Hexacon) ![GitHub last commit](https://img.shields.io/github/last-commit/gautier-gdx/Hexacon)](https://github.com/gautier-gdx/Hexacon) - A new way to display content in your app like the Apple Watch SpringBoard.
...
* [InfoView ![GitHub Repo stars](https://img.shields.io/github/stars/anatoliyv/InfoView) ![GitHub last commit](https://img.shields.io/github/last-commit/anatoliyv/InfoView)](https://github.com/anatoliyv/InfoView) - Simple information view with pointed arrow.
...
* [MediumScrollFullScreen ![GitHub Repo stars](https://img.shields.io/github/stars/pixyzehn/MediumScrollFullScreen) ![GitHub last commit](https://img.shields.io/github/last-commit/pixyzehn/MediumScrollFullScreen)](https://github.com/pixyzehn/MediumScrollFullScreen) - Medium scroll style menubar.
...
* [SAHistoryNavigationViewController ![GitHub Repo stars](https://img.shields.io/github/stars/marty-suzuki/SAHistoryNavigationViewController) ![GitHub last commit](https://img.shields.io/github/last-commit/marty-suzuki/SAHistoryNavigationViewController)](https://github.com/marty-suzuki/SAHistoryNavigationViewController) - iOS task manager like UI in UINavigationContoller.
...
* [TouchVisualizer ![GitHub Repo stars](https://img.shields.io/github/stars/morizotter/TouchVisualizer) ![GitHub last commit](https://img.shields.io/github/last-commit/morizotter/TouchVisualizer)](https://github.com/morizotter/TouchVisualizer) - Lightweight touch visualization library with a single line of code.
...
* [Hokusai ![GitHub Repo stars](https://img.shields.io/github/stars/ytakzk/Hokusai) ![GitHub last commit](https://img.shields.io/github/last-commit/ytakzk/Hokusai)](https://github.com/ytakzk/Hokusai) - A library for a cool bouncy action sheet.
* [Kamagari ![GitHub Repo stars](https://img.shields.io/github/stars/tasanobu/Kamagari) ![GitHub last commit](https://img.shields.io/github/last-commit/tasanobu/Kamagari)](https://github.com/tasanobu/Kamagari) - Simple UIAlertController builder class.
* [KRAlertController ![GitHub Repo stars](https://img.shields.io/github/stars/krimpedance/KRAlertController) ![GitHub last commit](https://img.shields.io/github/last-commit/krimpedance/KRAlertController)](https://github.com/krimpedance/KRAlertController) - A beautiful alert controller for your iOS.
...
* [SwiftyDrop ![GitHub Repo stars](https://img.shields.io/github/stars/morizotter/SwiftyDrop) ![GitHub last commit](https://img.shields.io/github/last-commit/morizotter/SwiftyDrop)](https://github.com/morizotter/SwiftyDrop) - Lightweight dropdown message bar.
...
* [SwiftForms ![GitHub Repo stars](https://img.shields.io/github/stars/ortuman/SwiftForms) ![GitHub last commit](https://img.shields.io/github/last-commit/ortuman/SwiftForms)](https://github.com/ortuman/SwiftForms) - Forms are now easy as 1-2-3.
...
* [SMIconLabel ![GitHub Repo stars](https://img.shields.io/github/stars/anatoliyv/SMIconLabel) ![GitHub last commit](https://img.shields.io/github/last-commit/anatoliyv/SMIconLabel)](https://github.com/anatoliyv/SMIconLabel) - UILabel with image placed from left or right.
...
* [CarLensCollectionViewLayout ![GitHub Repo stars](https://img.shields.io/github/stars/netguru/CarLensCollectionViewLayout) ![GitHub last commit](https://img.shields.io/github/last-commit/netguru/CarLensCollectionViewLayout)](https://github.com/netguru/CarLensCollectionViewLayout) - An easy-to-use Collection View Layout for card-like animation.
...
* [Shoyu ![GitHub Repo stars](https://img.shields.io/github/stars/yukiasai/Shoyu) ![GitHub last commit](https://img.shields.io/github/last-commit/yukiasai/Shoyu)](https://github.com/yukiasai/Shoyu) - Easier way to represent the structure of UITableView.
...
* [Butterfly ![GitHub Repo stars](https://img.shields.io/github/stars/wongzigii/Butterfly) ![GitHub last commit](https://img.shields.io/github/last-commit/wongzigii/Butterfly)](https://github.com/wongzigii/Butterfly) - A lightweight library for integrating bug-report and feedback features with shake-motion event.
...
* [DeepDiff ![GitHub Repo stars](https://img.shields.io/github/stars/onmyway133/DeepDiff) ![GitHub last commit](https://img.shields.io/github/last-commit/onmyway133/DeepDiff)](https://github.com/onmyway133/DeepDiff) - Fast diff library.
...
* [Focus ![GitHub Repo stars](https://img.shields.io/github/stars/typelift/Focus) ![GitHub last commit](https://img.shields.io/github/last-commit/typelift/Focus)](https://github.com/typelift/Focus) - Optics library (includes Lens, Prisms, and Isos) that is inspired by Haskell's Lens library.
...
* [Validator ![GitHub Repo stars](https://img.shields.io/github/stars/adamwaite/Validator) ![GitHub last commit](https://img.shields.io/github/last-commit/adamwaite/Validator)](https://github.com/adamwaite/Validator) - Drop in user input validation for your iOS apps.
...
* [VGPlayer ![GitHub Repo stars](https://img.shields.io/github/stars/VeinGuo/VGPlayer) ![GitHub last commit](https://img.shields.io/github/last-commit/VeinGuo/VGPlayer)](https://github.com/VeinGuo/VGPlayer) - A simple iOS video player, support play local and network, background playback mode, automatic caching while playing.
