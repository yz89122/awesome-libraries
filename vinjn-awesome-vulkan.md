...
*  [RadX ![GitHub Repo stars](https://img.shields.io/github/stars/world8th/RadX) ![GitHub last commit](https://img.shields.io/github/last-commit/world8th/RadX)](https://github.com/world8th/RadX) - Dedicated example of radix sorting on GPU (on NVIDIA RTX in particular).
...
*  [Hello Triangle ![GitHub Repo stars](https://img.shields.io/github/stars/helixd-2k18/VK_KHR_ray_tracing) ![GitHub last commit](https://img.shields.io/github/last-commit/helixd-2k18/VK_KHR_ray_tracing)](https://github.com/helixd-2k18/VK_KHR_ray_tracing), based on `VK_KHR_ray_tracing` extension. [MIT]
...
* Low Level
   ...
   *  [VKt/VKh ![GitHub Repo stars](https://img.shields.io/github/stars/helixd2s/vkt) ![GitHub last commit](https://img.shields.io/github/last-commit/helixd2s/vkt)](https://github.com/helixd2s/vkt), tools and helpers for Vulkan API, based and uses C++20. [MIT]
...
* Frameworks, Engines, Higher Level Rendering
   *  [Falcor ![GitHub Repo stars](https://img.shields.io/github/stars/NVIDIAGameWorks/Falcor) ![GitHub last commit](https://img.shields.io/github/last-commit/NVIDIAGameWorks/Falcor)](https://github.com/NVIDIAGameWorks/Falcor) - Real-time rendering framework from NVIDIA, supporting DX12 and Vulkan. [BSD 3-clause]
   ...
   *  [AMD's Anvil ![GitHub Repo stars](https://img.shields.io/github/stars/GPUOpen-LibrariesAndSDKs/Anvil) ![GitHub last commit](https://img.shields.io/github/last-commit/GPUOpen-LibrariesAndSDKs/Anvil)](https://github.com/GPUOpen-LibrariesAndSDKs/Anvil) - cross-platform framework for Vulkan. [[LICENSE ![GitHub Repo stars](https://img.shields.io/github/stars/GPUOpen-LibrariesAndSDKs/Anvil) ![GitHub last commit](https://img.shields.io/github/last-commit/GPUOpen-LibrariesAndSDKs/Anvil)](https://github.com/GPUOpen-LibrariesAndSDKs/Anvil/blob/master/LICENSE.txt)]
     * [Introductory Vulkan sample ![GitHub Repo stars](https://img.shields.io/github/stars/GPUOpen-LibrariesAndSDKs/HelloVulkan) ![GitHub last commit](https://img.shields.io/github/last-commit/GPUOpen-LibrariesAndSDKs/HelloVulkan)](https://github.com/GPUOpen-LibrariesAndSDKs/HelloVulkan). [MIT]
...
* Raytracing
   *  [vRt ![GitHub Repo stars](https://img.shields.io/github/stars/world8th/vRt) ![GitHub last commit](https://img.shields.io/github/last-commit/world8th/vRt)](https://github.com/world8th/vRt) - Vulkan API (>=1.1) based unified ray tracing library. [LGPL-3.0]
...
*  [VulkanTools ![GitHub Repo stars](https://img.shields.io/github/stars/LunarG/VulkanTools) ![GitHub last commit](https://img.shields.io/github/last-commit/LunarG/VulkanTools)](https://github.com/LunarG/VulkanTools) - LunarG's tools including layers, `vktrace` and `vkreplay`. [Apache Licence 2.0]
...
*  [Open Capture and Analytics Tool (OCAT) ![GitHub Repo stars](https://img.shields.io/github/stars/GPUOpen-Tools/OCAT) ![GitHub last commit](https://img.shields.io/github/last-commit/GPUOpen-Tools/OCAT)](https://github.com/GPUOpen-Tools/OCAT) - rovides an FPS overlay and performance measurement for D3D11, D3D12, and Vulkan. [MIT]
