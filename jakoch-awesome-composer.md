...
- [Composer-Curl-Plugin ![GitHub Repo stars](https://img.shields.io/github/stars/ngyuki/composer-curl-plugin) ![GitHub last commit](https://img.shields.io/github/last-commit/ngyuki/composer-curl-plugin)](https://github.com/ngyuki/composer-curl-plugin) - The plugin use phpext_curl for downloading packages.
...
- [Composer Exclusive Install ![GitHub Repo stars](https://img.shields.io/github/stars/erickskrauch/composer-exclusive-install) ![GitHub last commit](https://img.shields.io/github/last-commit/erickskrauch/composer-exclusive-install)](https://github.com/erickskrauch/composer-exclusive-install) - Prevents more than one install or update operation at a time.
