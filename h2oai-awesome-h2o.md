...
[<img src="https://rawgit.com/h2oai/awesome-h2o/master/h2o_logo.png" align="right" width="100"> ![GitHub Repo stars](https://img.shields.io/github/stars/h2oai/h2o-3) ![GitHub last commit](https://img.shields.io/github/last-commit/h2oai/h2o-3)](https://github.com/h2oai/h2o-3)

Below is a curated list of all the awesome projects, applications, research, tutorials, courses and books that use [H2O ![GitHub Repo stars](https://img.shields.io/github/stars/h2oai/h2o-3) ![GitHub last commit](https://img.shields.io/github/last-commit/h2oai/h2o-3)](https://github.com/h2oai/h2o-3), an open source, distributed machine learning platform.  H2O offers parallelized implementations of many supervised and unsupervised machine learning algorithms such as Generalized Linear Models, Gradient Boosting Machines (including XGBoost), Random Forests, Deep Neural Networks (Deep Learning), Stacked Ensembles, Naive Bayes, Cox Proportional Hazards, K-means, PCA, Word2Vec, as well as a fully automatic machine learning algorithm (AutoML).

[H2O.ai](http://www.h2o.ai/about/) produces many [tutorials ![GitHub Repo stars](https://img.shields.io/github/stars/h2oai/h2o-tutorials) ![GitHub last commit](https://img.shields.io/github/last-commit/h2oai/h2o-tutorials)](https://github.com/h2oai/h2o-tutorials), [blog posts](http://blog.h2o.ai/), [presentations ![GitHub Repo stars](https://img.shields.io/github/stars/h2oai/h2o-meetups) ![GitHub last commit](https://img.shields.io/github/last-commit/h2oai/h2o-meetups)](https://github.com/h2oai/h2o-meetups) and [videos](https://www.youtube.com/user/0xdata) about H2O, but the list below is comprised of awesome content produced by the greater H2O user community.
...
If you think H2O is awesome too, please ⭐ the [H2O GitHub repository ![GitHub Repo stars](https://img.shields.io/github/stars/h2oai/h2o-3) ![GitHub last commit](https://img.shields.io/github/last-commit/h2oai/h2o-3)](https://github.com/h2oai/h2o-3/).
...
- [Stock Market Analysis using Stacked Ensemble Learning Method ![GitHub Repo stars](https://img.shields.io/github/stars/malhartakle/MastersDissertation) ![GitHub last commit](https://img.shields.io/github/last-commit/malhartakle/MastersDissertation)](https://github.com/malhartakle/MastersDissertation/blob/master/Research%20Project%20Report.pdf)  Malkar Takle. (2020)
...
- [Understanding random forests: from theory to practice ![GitHub Repo stars](https://img.shields.io/github/stars/glouppe/phd-thesis) ![GitHub last commit](https://img.shields.io/github/last-commit/glouppe/phd-thesis)](https://github.com/glouppe/phd-thesis) Gilles Louppe. (2014)
...
- [Szilard's machine learning benchmark ![GitHub Repo stars](https://img.shields.io/github/stars/szilard/benchm-ml) ![GitHub last commit](https://img.shields.io/github/last-commit/szilard/benchm-ml)](https://github.com/szilard/benchm-ml) - Benchmarks of Random Forest, GBM, Deep Learning and GLM implementations in common open source ML frameworks. Jul 3, 2015
...
- [University of San Francisco (USF) Distributed Data System Class (MSDS 697) ![GitHub Repo stars](https://img.shields.io/github/stars/dianewoodbridge/2020-msds697-example) ![GitHub last commit](https://img.shields.io/github/last-commit/dianewoodbridge/2020-msds697-example)](https://github.com/dianewoodbridge/2020-msds697-example) - Master of Science in Data Science Program.
...
- [UCLA: Tools in Data Science (STATS 418) ![GitHub Repo stars](https://img.shields.io/github/stars/szilard/teach-data-science-UCLA-master-appl-stats) ![GitHub last commit](https://img.shields.io/github/last-commit/szilard/teach-data-science-UCLA-master-appl-stats)](https://github.com/szilard/teach-data-science-UCLA-master-appl-stats) - Masters of Applied Statistics Program.
- [GWU: Data Mining (Decision Sciences 6279) ![GitHub Repo stars](https://img.shields.io/github/stars/jphall663/GWU_data_mining) ![GitHub last commit](https://img.shields.io/github/last-commit/jphall663/GWU_data_mining)](https://github.com/jphall663/GWU_data_mining) - Masters of Science in Business Analytics.
...
- [Evaporate ![GitHub Repo stars](https://img.shields.io/github/stars/ML4LHS/Evaporate) ![GitHub last commit](https://img.shields.io/github/last-commit/ML4LHS/Evaporate)](https://github.com/ML4LHS/Evaporate): Run H2O models in the browser via Javascript.  More info [here](https://twitter.com/kdpsinghlab/status/1367992786239242248).
- [splash R package ![GitHub Repo stars](https://img.shields.io/github/stars/ML4LHS/splash) ![GitHub last commit](https://img.shields.io/github/last-commit/ML4LHS/splash)](https://github.com/ML4LHS/splash): Splashing a User Interface onto H2O MOJO Files.  More info [here](https://twitter.com/kdpsinghlab/status/1367809740705792008).
- [h2oparsnip R package ![GitHub Repo stars](https://img.shields.io/github/stars/stevenpawley/h2oparsnip) ![GitHub last commit](https://img.shields.io/github/last-commit/stevenpawley/h2oparsnip)](https://github.com/stevenpawley/h2oparsnip): Set of wrappers to bind h2o algorthms with the [parsnip](https://parsnip.tidymodels.org/) package.
- [Spin up PySpark and PySparkling on AWS ![GitHub Repo stars](https://img.shields.io/github/stars/kcrandall/EMR_Spark_Automation) ![GitHub last commit](https://img.shields.io/github/last-commit/kcrandall/EMR_Spark_Automation)](https://github.com/kcrandall/EMR_Spark_Automation)
