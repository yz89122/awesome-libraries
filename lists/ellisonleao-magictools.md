...
- :tada: [Pixel Composer ![GitHub Repo Stars](https://img.shields.io/github/stars/Ttanasart-pt/Pixel-Composer) ![GitHub last commit](https://img.shields.io/github/last-commit/Ttanasart-pt/Pixel-Composer)](https://github.com/Ttanasart-pt/Pixel-Composer) - Powerful node-based VFX editor for pixel art
...
- :free [Canvascript ![GitHub Repo Stars](https://img.shields.io/github/stars/VBproDev/Canvascript) ![GitHub last commit](https://img.shields.io/github/last-commit/VBproDev/Canvascript)](https://github.com/VBproDev/Canvascript) - A tool for creating HTML canvas graphics without writing code.
...
- :tada: [6502 Unit Test executor ![GitHub Repo Stars](https://img.shields.io/github/stars/AsaiYusuke/6502_test_executor) ![GitHub last commit](https://img.shields.io/github/last-commit/AsaiYusuke/6502_test_executor)](https://github.com/AsaiYusuke/6502_test_executor) - A cross-platform unit testing tool for MOS 6502 assembly. (i.e. NES)
...
- :tada: [asimov-ts ![GitHub Repo Stars](https://img.shields.io/github/stars/pedrozaalex/asimov-ts) ![GitHub last commit](https://img.shields.io/github/last-commit/pedrozaalex/asimov-ts)](https://github.com/pedrozaalex/asimov-ts) - A type safe (as much as possible) engine for the web written in TypeScript.
...
- :tada: [axys ![GitHub Repo Stars](https://img.shields.io/github/stars/axys1/axys) ![GitHub last commit](https://img.shields.io/github/last-commit/axys1/axys)](https://github.com/axys1/axys) - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
- :tada: [DotRecast ![GitHub Repo Stars](https://img.shields.io/github/stars/ikpil/DotRecast) ![GitHub last commit](https://img.shields.io/github/last-commit/ikpil/DotRecast)](https://github.com/ikpil/DotRecast) - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
...
- :tada: [Foster ![GitHub Repo Stars](https://img.shields.io/github/stars/FosterFramework/Foster) ![GitHub last commit](https://img.shields.io/github/last-commit/FosterFramework/Foster)](https://github.com/FosterFramework/Foster) - A small cross-platform 2D game framework in C#.
...
- :tada: [Grid ![GitHub Repo Stars](https://img.shields.io/github/stars/Planimeter/game-engine-2d) ![GitHub last commit](https://img.shields.io/github/last-commit/Planimeter/game-engine-2d)](https://github.com/Planimeter/game-engine-2d) - A multiplayer-first game engine for Lua.
...
- :tada: [JNGL ![GitHub Repo Stars](https://img.shields.io/github/stars/jhasse/jngl) ![GitHub last commit](https://img.shields.io/github/last-commit/jhasse/jngl)](https://github.com/jhasse/jngl) - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
- :tada: [OpenXRay ![GitHub Repo Stars](https://img.shields.io/github/stars/OpenXRay/xray-16) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenXRay/xray-16)](https://github.com/OpenXRay/xray-16) - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
- :tada: [Pixel Vision 8 ![GitHub Repo Stars](https://img.shields.io/github/stars/PixelVision8/PixelVision8) ![GitHub last commit](https://img.shields.io/github/last-commit/PixelVision8/PixelVision8)](https://github.com/PixelVision8/PixelVision8) - Pixel Vision 8's core philosophy is to teach retro game development with streamlined workflows. PV8 is also a platform that standardizes 8-bit fantasy console limitations built on top of the open-source C# game engine based on MonoGame.
...
- :tada: [Pyxel ![GitHub Repo Stars](https://img.shields.io/github/stars/kitao/pyxel) ![GitHub last commit](https://img.shields.io/github/last-commit/kitao/pyxel)](https://github.com/kitao/pyxel) - a retro game engine for Python.
...
- :tada: [RGFW ![GitHub Repo Stars](https://img.shields.io/github/stars/ColleagueRiley/RGFW) ![GitHub last commit](https://img.shields.io/github/last-commit/ColleagueRiley/RGFW)](https://github.com/ColleagueRiley/RGFW) - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
- :tada: [Screen 13 ![GitHub Repo Stars](https://img.shields.io/github/stars/attackgoat/screen-13) ![GitHub last commit](https://img.shields.io/github/last-commit/attackgoat/screen-13)](https://github.com/attackgoat/screen-13) - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
...
- :free: [Famistudio ![GitHub Repo Stars](https://img.shields.io/github/stars/BleuBleu/FamiStudio) ![GitHub last commit](https://img.shields.io/github/last-commit/BleuBleu/FamiStudio)](https://github.com/BleuBleu/FamiStudio) - FamiStudio NES Music Editor.
