...
- [Scaling up search engine audits: Practical insights for algorithm auditing](https://journals.sagepub.com/doi/10.1177/01655515221093029) - (Journal of Information Science) [(Code) ![GitHub Repo Stars](https://img.shields.io/github/stars/gesiscss/WebBot) ![GitHub last commit](https://img.shields.io/github/last-commit/gesiscss/WebBot)](https://github.com/gesiscss/WebBot) *Audits multiple search engines using simulated browsing behavior with virtual agents.*
...
- [Remote Explainability faces the bouncer problem](https://rdcu.be/b6qB4) - (Nature Machine Intelligence volume 2, pages529–539)  [(Code) ![GitHub Repo Stars](https://img.shields.io/github/stars/erwanlemerrer/bouncer_problem) ![GitHub last commit](https://img.shields.io/github/last-commit/erwanlemerrer/bouncer_problem)](https://github.com/erwanlemerrer/bouncer_problem) *Shows the impossibility (with one request) or the difficulty to spot lies on the explanations of a remote AI decision.*
- [GeoDA: a geometric framework for black-box adversarial attacks](https://openaccess.thecvf.com/content_CVPR_2020/papers/Rahmati_GeoDA_A_Geometric_Framework_for_Black-Box_Adversarial_Attacks_CVPR_2020_paper.pdf) - (CVPR)  [(Code) ![GitHub Repo Stars](https://img.shields.io/github/stars/thisisalirah/GeoDA) ![GitHub last commit](https://img.shields.io/github/last-commit/thisisalirah/GeoDA)](https://github.com/thisisalirah/GeoDA) *Crafts adversarial examples to fool models, in a pure blackbox setup (no gradients, inferred class only).*
- [The Imitation Game: Algorithm Selectionby Exploiting Black-Box Recommender ![GitHub Repo Stars](https://img.shields.io/github/stars/erwanlemerrer/erwanlemerrer.github.io) ![GitHub last commit](https://img.shields.io/github/last-commit/erwanlemerrer/erwanlemerrer.github.io)](https://github.com/erwanlemerrer/erwanlemerrer.github.io/raw/master/files/imitation_blackbox_recommenders_netys-2020.pdf) - (Netys)  [(Code) ![GitHub Repo Stars](https://img.shields.io/github/stars/gdamaskinos/RecRank) ![GitHub last commit](https://img.shields.io/github/last-commit/gdamaskinos/RecRank)](https://github.com/gdamaskinos/RecRank) *Parametrize a local recommendation algorithm by imitating the decision of a remote and better trained one.*
...
### 2019
- [Adversarial Frontier Stitching for Remote Neural Network Watermarking](https://arxiv.org/abs/1711.01894) - (Neural Computing and Applications) [(Alternative implementation) ![GitHub Repo Stars](https://img.shields.io/github/stars/dunky11/adversarial-frontier-stitching) ![GitHub last commit](https://img.shields.io/github/last-commit/dunky11/adversarial-frontier-stitching)](https://github.com/dunky11/adversarial-frontier-stitching) *Check if a remote machine learning model is a "leaked" one: through standard API requests to a remote model, extract (or not) a zero-bit watermark, that was inserted to watermark valuable models (eg, large deep neural networks).*
...
- [Towards Reverse-Engineering Black-Box Neural Networks](https://arxiv.org/abs/1711.01768) - (ICLR) [(Code) ![GitHub Repo Stars](https://img.shields.io/github/stars/coallaoh/WhitenBlackBox) ![GitHub last commit](https://img.shields.io/github/last-commit/coallaoh/WhitenBlackBox)](https://github.com/coallaoh/WhitenBlackBox) *Infer inner hyperparameters (eg number of layers, non-linear activation type) of a remote neural network model by analysing its response patterns to certain inputs.*
...
- [Copycat CNN: Stealing Knowledge by Persuading Confession with Random Non-Labeled Data](https://arxiv.org/abs/1806.05476) - (IJCNN)  [(Code) ![GitHub Repo Stars](https://img.shields.io/github/stars/jeiks/Stealing_DL_Models) ![GitHub last commit](https://img.shields.io/github/last-commit/jeiks/Stealing_DL_Models)](https://github.com/jeiks/Stealing_DL_Models) *Stealing black-box models (CNNs) knowledge by querying them with random natural images (ImageNet and Microsoft-COCO).*
...
- [Stealing Machine Learning Models via Prediction APIs](https://www.usenix.org/conference/usenixsecurity16/technical-sessions/presentation/tramer) - (Usenix Security)  [(Code) ![GitHub Repo Stars](https://img.shields.io/github/stars/ftramer/Steal-ML) ![GitHub last commit](https://img.shields.io/github/last-commit/ftramer/Steal-ML)](https://github.com/ftramer/Steal-ML) *Aims at extracting machine learning models in use by remote services.*
- [“Why Should I Trust You?”Explaining the Predictions of Any Classifier](https://arxiv.org/pdf/1602.04938v3.pdf) - (arXiv)  [(Code) ![GitHub Repo Stars](https://img.shields.io/github/stars/marcotcr/lime-experiments) ![GitHub last commit](https://img.shields.io/github/last-commit/marcotcr/lime-experiments)](https://github.com/marcotcr/lime-experiments) *Explains a blackbox classifier model by sampling around data instances.*
...
### 2014
- [A peek into the black box: exploring classifiers by randomization]() - (Data Mining and Knowledge Discovery journal) ([code ![GitHub Repo Stars](https://img.shields.io/github/stars/tsabsch/goldeneye) ![GitHub last commit](https://img.shields.io/github/last-commit/tsabsch/goldeneye)](https://github.com/tsabsch/goldeneye)) *Finds groups of features that can be permuted without changing the output label of predicted samples*
