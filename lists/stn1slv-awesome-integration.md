...
- [Zudoku (⭐116) ![GitHub Repo Stars](https://img.shields.io/github/stars/zuplo/zudoku) ![GitHub last commit](https://img.shields.io/github/last-commit/zuplo/zudoku)](https://github.com/zuplo/zudoku) - An open-source, OpenAPI powered, highly customizable API documentation framework for building quality developer experiences.
...
- Mocking tools
  ...
  - [Mockbin (⭐96) ![GitHub Repo Stars](https://img.shields.io/github/stars/zuplo/mockbin) ![GitHub last commit](https://img.shields.io/github/last-commit/zuplo/mockbin)](https://github.com/zuplo/mockbin) - Easily generate custom endpoints to test HTTP requests, and view the request logs from that API for free.
