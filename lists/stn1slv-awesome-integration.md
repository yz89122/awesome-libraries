...
- [Gravitee.io API Management (⭐216) ![GitHub Repo Stars](https://img.shields.io/github/stars/gravitee-io/gravitee-api-management) ![GitHub last commit](https://img.shields.io/github/last-commit/gravitee-io/gravitee-api-management)](https://github.com/gravitee-io/gravitee-api-management) - A flexible, lightweight, and open-source API management solution that provides comprehensive API management capabilities and helps you manage your APIs with ease.
...
- [WSO2 API Manager (⭐873) ![GitHub Repo Stars](https://img.shields.io/github/stars/wso2/product-apim) ![GitHub last commit](https://img.shields.io/github/last-commit/wso2/product-apim)](https://github.com/wso2/product-apim) - A fully open-source API management platform that provides comprehensive API management capabilities and allows you to manage APIs with ease.
...
- [Dredd (⭐4.2k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apiaryio/dredd) ![GitHub last commit](https://img.shields.io/github/last-commit/apiaryio/dredd)](https://github.com/apiaryio/dredd) - Validate API description docs against backend implementation using this language-agnostic CLI tool.
- [OpenAPI-GUI (⭐1.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/Mermade/openapi-gui) ![GitHub last commit](https://img.shields.io/github/last-commit/Mermade/openapi-gui)](https://github.com/Mermade/openapi-gui) - Create and validate OpenAPI specs with ease using this intuitive graphical user interface.
- [OpenAPI Diff (⭐869) ![GitHub Repo Stars](https://img.shields.io/github/stars/OpenAPITools/openapi-diff) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenAPITools/openapi-diff)](https://github.com/OpenAPITools/openapi-diff) - Compare OpenAPI specs with version control and visualize the differences in HTML or Markdown format.
- [OpenAPI Generator (⭐22k) ![GitHub Repo Stars](https://img.shields.io/github/stars/OpenAPITools/openapi-generator) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenAPITools/openapi-generator)](https://github.com/OpenAPITools/openapi-generator) - Automate the creation of API client libraries, server stubs, documentation and config files with this powerful OpenAPI Spec tool.
- [OpenAPI Style Validator (⭐214) ![GitHub Repo Stars](https://img.shields.io/github/stars/OpenAPITools/openapi-style-validator) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenAPITools/openapi-style-validator)](https://github.com/OpenAPITools/openapi-style-validator) - Ensure that your OpenAPI specs meet your organization's standards with this flexible and customizable style validator.
- [Spectral (⭐2.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/stoplightio/spectral) ![GitHub last commit](https://img.shields.io/github/last-commit/stoplightio/spectral)](https://github.com/stoplightio/spectral) - Detect and fix errors in your JSON/YAML files using this linter tool that supports OpenAPI 3.0 & 2.0 and AsyncAPI.
- [Swagger Editor (⭐9k) ![GitHub Repo Stars](https://img.shields.io/github/stars/swagger-api/swagger-editor) ![GitHub last commit](https://img.shields.io/github/last-commit/swagger-api/swagger-editor)](https://github.com/swagger-api/swagger-editor) - Create, describe, and document your API with ease using this open source editor built specifically for OpenAPI-based APIs.
- [Zally (⭐920) ![GitHub Repo Stars](https://img.shields.io/github/stars/zalando/zally) ![GitHub last commit](https://img.shields.io/github/last-commit/zalando/zally)](https://github.com/zalando/zally) - Ensure the quality of your OpenAPI specs with this linter tool that provides extensive analysis and feedback.
...
- [DapperDox (⭐413) ![GitHub Repo Stars](https://img.shields.io/github/stars/DapperDox/dapperdox) ![GitHub last commit](https://img.shields.io/github/last-commit/DapperDox/dapperdox)](https://github.com/DapperDox/dapperdox) - An open-source API documentation generator and server for OpenAPI/Swagger specifications, with customizable documentation, automated updates, and easy sharing.
- [OpenAPI Explorer (⭐322) ![GitHub Repo Stars](https://img.shields.io/github/stars/Rhosys/openapi-explorer) ![GitHub last commit](https://img.shields.io/github/last-commit/Rhosys/openapi-explorer)](https://github.com/Rhosys/openapi-explorer) - A tool for generating user interfaces from OpenAPI specifications, making it easier for software engineers to visualize and interact with APIs.
- [RapiDoc (⭐1.7k) ![GitHub Repo Stars](https://img.shields.io/github/stars/rapi-doc/RapiDoc) ![GitHub last commit](https://img.shields.io/github/last-commit/rapi-doc/RapiDoc)](https://github.com/rapi-doc/RapiDoc) - A tool that generates customizable, interactive API documentation from OpenAPI Specification, with a range of design options.
- [Redoc (⭐23k) ![GitHub Repo Stars](https://img.shields.io/github/stars/Redocly/redoc) ![GitHub last commit](https://img.shields.io/github/last-commit/Redocly/redoc)](https://github.com/Redocly/redoc) - An open-source tool for generating documentation from OpenAPI (fka Swagger) definitions, with customizable themes, language support, and branding.
- [Slate (⭐36k) ![GitHub Repo Stars](https://img.shields.io/github/stars/slatedocs/slate) ![GitHub last commit](https://img.shields.io/github/last-commit/slatedocs/slate)](https://github.com/slatedocs/slate) - A powerful tool that creates static API documentation from markdown, with API reference docs and code samples.
- [Stoplight Elements (⭐1.9k) ![GitHub Repo Stars](https://img.shields.io/github/stars/stoplightio/elements) ![GitHub last commit](https://img.shields.io/github/last-commit/stoplightio/elements)](https://github.com/stoplightio/elements) - Beautiful API documentation powered by OpenAPI and Markdown. Use these UI components to create API reference documentation, or more complete documentation with Markdown articles covering tutorials, how-to guides, etc.
...
- [Swagger UI (⭐26k) ![GitHub Repo Stars](https://img.shields.io/github/stars/swagger-api/swagger-ui) ![GitHub last commit](https://img.shields.io/github/last-commit/swagger-api/swagger-ui)](https://github.com/swagger-api/swagger-ui) - An intuitive tool for exploring and interacting with APIs, with API specification visualization, endpoint exploration, and built-in interactive console.
- [SpectaQL (⭐1.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/anvilco/spectaql) ![GitHub last commit](https://img.shields.io/github/last-commit/anvilco/spectaql)](https://github.com/anvilco/spectaql) - A Node.js library that generates static documentation for a GraphQL schema from various sources, including live endpoint, query result, and SDL files.
- [Zudoku (⭐135) ![GitHub Repo Stars](https://img.shields.io/github/stars/zuplo/zudoku) ![GitHub last commit](https://img.shields.io/github/last-commit/zuplo/zudoku)](https://github.com/zuplo/zudoku) - An open-source, OpenAPI powered, highly customizable API documentation framework for building quality developer experiences.
...
- [Apinto (⭐1.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/eolinker/goku) ![GitHub last commit](https://img.shields.io/github/last-commit/eolinker/goku)](https://github.com/eolinker/goku) - A Golang-based microservice gateway that provides dynamic routing, service orchestration, multi-tenancy management, and API access control.
...
- [Apache APISIX (⭐14k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/apisix) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/apisix)](https://github.com/apache/apisix) - A dynamic, real-time, and high-performance API Gateway that leverages Apache plugins for enhanced functionality.
- [Apache ShenYu (⭐8.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/shenyu) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/shenyu)](https://github.com/apache/shenyu) - A Java native API Gateway for service proxy, protocol conversion and API governance.
- [Gloo Edge (⭐55) ![GitHub Repo Stars](https://img.shields.io/github/stars/solo-io/gloo) ![GitHub last commit](https://img.shields.io/github/last-commit/solo-io/gloo)](https://github.com/solo-io/gloo) - An Envoy Proxy-based API Gateway that provides advanced traffic management, security, and observability features for modern microservices architectures.
- [Kong API Gateway (⭐39k) ![GitHub Repo Stars](https://img.shields.io/github/stars/Kong/kong) ![GitHub last commit](https://img.shields.io/github/last-commit/Kong/kong)](https://github.com/Kong/kong) - A cloud-native, platform-agnostic, and scalable API Gateway that supports plugins for easy integration with third-party services.
- [KrakenD API Gateway (⭐2.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/devopsfaith/krakend-ce) ![GitHub last commit](https://img.shields.io/github/last-commit/devopsfaith/krakend-ce)](https://github.com/devopsfaith/krakend-ce) - An ultra-high performance API Gateway that leverages middlewares for fast and efficient API management.
- [Ocelot (⭐8.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/ThreeMammals/Ocelot) ![GitHub last commit](https://img.shields.io/github/last-commit/ThreeMammals/Ocelot)](https://github.com/ThreeMammals/Ocelot) - A .NET API Gateway that provides a simple and elegant way to manage APIs with its intuitive routing and middleware configuration.
- [Spring Cloud Gateway (⭐4.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/spring-cloud/spring-cloud-gateway) ![GitHub last commit](https://img.shields.io/github/last-commit/spring-cloud/spring-cloud-gateway)](https://github.com/spring-cloud/spring-cloud-gateway) - An API Gateway built on top of the Spring ecosystem, providing advanced routing and filtering features for Spring applications.
- [Traefik (⭐53k) ![GitHub Repo Stars](https://img.shields.io/github/stars/traefik/traefik) ![GitHub last commit](https://img.shields.io/github/last-commit/traefik/traefik)](https://github.com/traefik/traefik) - A modern, open-source API Gateway that is designed to handle dynamic container environments such as Kubernetes, Docker Swarm, and Mesos. It provides load balancing, SSL/TLS termination, rate limiting, circuit breaking, and more.
- [Tyk API Gateway (⭐9.8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/TykTechnologies/tyk) ![GitHub last commit](https://img.shields.io/github/last-commit/TykTechnologies/tyk)](https://github.com/TykTechnologies/tyk) - An open source Enterprise API Gateway that supports REST, GraphQL, TCP, and gRPC protocols. It provides advanced API management features such as rate limiting, access control, and analytics.
...
- API clients
  - [Advanced REST Client (⭐1.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/advanced-rest-client/arc-electron) ![GitHub last commit](https://img.shields.io/github/last-commit/advanced-rest-client/arc-electron)](https://github.com/advanced-rest-client/arc-electron) - An open-source API tool designed for testing and debugging RESTful web services.
  - [Bruno (⭐30k) ![GitHub Repo Stars](https://img.shields.io/github/stars/usebruno/bruno) ![GitHub last commit](https://img.shields.io/github/last-commit/usebruno/bruno)](https://github.com/usebruno/bruno) - A fast, git-friendly, and offline-only opensource API client.
  - [curl (⭐36k) ![GitHub Repo Stars](https://img.shields.io/github/stars/curl/curl) ![GitHub last commit](https://img.shields.io/github/last-commit/curl/curl)](https://github.com/curl/curl) - Command-line tool for transferring data with URLs over various protocols.
  - [curlie (⭐3k) ![GitHub Repo Stars](https://img.shields.io/github/stars/rs/curlie) ![GitHub last commit](https://img.shields.io/github/last-commit/rs/curlie)](https://github.com/rs/curlie) - Frontend to curl with the ease of use of httpie without compromising on performance and features.
  - [HTTPie (⭐34k) ![GitHub Repo Stars](https://img.shields.io/github/stars/httpie/httpie) ![GitHub last commit](https://img.shields.io/github/last-commit/httpie/httpie)](https://github.com/httpie/httpie) - User-friendly command-line HTTP client that simplifies HTTP request/response inspection and manipulation.
  - [Hoppscotch (⭐67k) ![GitHub Repo Stars](https://img.shields.io/github/stars/hoppscotch/hoppscotch) ![GitHub last commit](https://img.shields.io/github/last-commit/hoppscotch/hoppscotch)](https://github.com/hoppscotch/hoppscotch) - A fast, open-source API development tool available as a web app.
  - [Insomnia (⭐35k) ![GitHub Repo Stars](https://img.shields.io/github/stars/Kong/insomnia) ![GitHub last commit](https://img.shields.io/github/last-commit/Kong/insomnia)](https://github.com/Kong/insomnia) - Cross-platform HTTP and GraphQL client designed to make API testing and debugging easier.
  - [posting (⭐7.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/darrenburns/posting) ![GitHub last commit](https://img.shields.io/github/last-commit/darrenburns/posting)](https://github.com/darrenburns/posting) - The modern API client that lives in your terminal.
  ...
  - [resty (⭐2.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/micha/resty) ![GitHub last commit](https://img.shields.io/github/last-commit/micha/resty)](https://github.com/micha/resty) - A Lua framework for building HTTP clients that provides a shell interface for interacting with REST services.
  - [SoapUI (⭐1.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/SmartBear/soapui) ![GitHub last commit](https://img.shields.io/github/last-commit/SmartBear/soapui)](https://github.com/SmartBear/soapui) - Open-source web service testing application designed for testing SOAP and REST web services.
- MQ clients
  - [JMSToolBox (⭐210) ![GitHub Repo Stars](https://img.shields.io/github/stars/jmstoolbox/jmstoolbox) ![GitHub last commit](https://img.shields.io/github/last-commit/jmstoolbox/jmstoolbox)](https://github.com/jmstoolbox/jmstoolbox) - Universal JMS client designed to interact with a wide range of JMS-based message brokers.
  - [kcat (⭐5.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/edenhill/kcat) ![GitHub last commit](https://img.shields.io/github/last-commit/edenhill/kcat)](https://github.com/edenhill/kcat) - Generic non-JVM producer and consumer for Apache Kafka, functioning as a netcat for Kafka.
  - [MQTT Explorer (⭐3.2k) ![GitHub Repo Stars](https://img.shields.io/github/stars/thomasnordquist/MQTT-Explorer) ![GitHub last commit](https://img.shields.io/github/last-commit/thomasnordquist/MQTT-Explorer)](https://github.com/thomasnordquist/MQTT-Explorer) - All-round MQTT client with a structured topic overview, suitable for debugging and testing MQTT-based systems.
...
- Mocking tools
  - [Imposter (⭐381) ![GitHub Repo Stars](https://img.shields.io/github/stars/outofcoffee/imposter) ![GitHub last commit](https://img.shields.io/github/last-commit/outofcoffee/imposter)](https://github.com/outofcoffee/imposter) - Mock server for REST APIs, OpenAPI (and Swagger) specifications, SOAP web services (and WSDL files), Salesforce and HBase APIs.
  - [Microcks (⭐1.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/microcks/microcks) ![GitHub last commit](https://img.shields.io/github/last-commit/microcks/microcks)](https://github.com/microcks/microcks) - Open-source Kubernetes-native tool for API mocking and testing, supporting AsyncAPI, OpenAPI, Postman Collections, etc.
  - [Mockable](https://www.mockable.io/) - Simple configurable service to mock out RESTful API or SOAP web-services.
  - [Mockbin (⭐103) ![GitHub Repo Stars](https://img.shields.io/github/stars/zuplo/mockbin) ![GitHub last commit](https://img.shields.io/github/last-commit/zuplo/mockbin)](https://github.com/zuplo/mockbin) - Easily generate custom endpoints to test HTTP requests, and view the request logs from that API for free.
  - [Mockoon (⭐6.8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/mockoon/mockoon) ![GitHub last commit](https://img.shields.io/github/last-commit/mockoon/mockoon)](https://github.com/mockoon/mockoon) - Easy-to-use tool for designing and running mock REST APIs.
  - [MockServer (⭐4.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/mock-server/mockserver) ![GitHub last commit](https://img.shields.io/github/last-commit/mock-server/mockserver)](https://github.com/mock-server/mockserver) - Easy mocking of any system you integrate with via HTTP or HTTPS.
  ...
  - [Prism (⭐4.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/stoplightio/prism) ![GitHub last commit](https://img.shields.io/github/last-commit/stoplightio/prism)](https://github.com/stoplightio/prism) - Open-source HTTP mock server that can mimic your API's behavior as if you already built it.
  - [WireMock (⭐6.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/tomakehurst/wiremock) ![GitHub last commit](https://img.shields.io/github/last-commit/tomakehurst/wiremock)](https://github.com/tomakehurst/wiremock) - Mock your APIs for fast, robust, and comprehensive testing.
- Testing tools and frameworks
  - [Apache JMeter (⭐8.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/jmeter) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/jmeter)](https://github.com/apache/jmeter) - Open-source Java-based load testing tool that can be used to test the performance and scalability of web applications, databases, and other network services.
  - [Gatling (⭐6.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/gatling/gatling) ![GitHub last commit](https://img.shields.io/github/last-commit/gatling/gatling)](https://github.com/gatling/gatling) - An open-source load testing tool that allows users to write and run load tests as code, providing detailed performance reports to optimize system performance.
  - [Karate (⭐8.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/intuit/karate) ![GitHub last commit](https://img.shields.io/github/last-commit/intuit/karate)](https://github.com/intuit/karate) - Open-source tool that combines API test-automation, mocks, performance-testing, and even UI automation into a single, unified framework.
  - [Pyresttest (⭐1.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/svanoort/pyresttest) ![GitHub last commit](https://img.shields.io/github/last-commit/svanoort/pyresttest)](https://github.com/svanoort/pyresttest) - Python-based REST testing and API microbenchmarking tool that uses YAML or JSON for test.
  - [REST Assured (⭐6.8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/rest-assured/rest-assured) ![GitHub last commit](https://img.shields.io/github/last-commit/rest-assured/rest-assured)](https://github.com/rest-assured/rest-assured) - Java DSL for easy testing of REST services.
  - [Schemathesis (⭐2.3k) ![GitHub Repo Stars](https://img.shields.io/github/stars/schemathesis/schemathesis) ![GitHub last commit](https://img.shields.io/github/last-commit/schemathesis/schemathesis)](https://github.com/schemathesis/schemathesis) - Python library for property-based testing of API schemas.
  - [Taurus (⭐2k) ![GitHub Repo Stars](https://img.shields.io/github/stars/Blazemeter/taurus) ![GitHub last commit](https://img.shields.io/github/last-commit/Blazemeter/taurus)](https://github.com/Blazemeter/taurus) - An open-source framework for continuous testing that simplifies test execution and management through a user-friendly interface and integrates with various testing tools and frameworks.
...
- [Drools (⭐5.9k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/incubator-kie-drools) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/incubator-kie-drools)](https://github.com/apache/incubator-kie-drools) - Open-source tool that supports Decision Model and Notation (DMN) models at Conformance level 3 with an Eclipse IDE plugin for core development.
- [Easy Rules (⭐4.9k) ![GitHub Repo Stars](https://img.shields.io/github/stars/j-easy/easy-rules) ![GitHub last commit](https://img.shields.io/github/last-commit/j-easy/easy-rules)](https://github.com/j-easy/easy-rules) - Simple Java rules engine for straightforward rule processing.
- [NxBRE (⭐131) ![GitHub Repo Stars](https://img.shields.io/github/stars/ddossot/NxBRE) ![GitHub last commit](https://img.shields.io/github/last-commit/ddossot/NxBRE)](https://github.com/ddossot/NxBRE) - Open-source rule engine specifically designed for the .NET platform.
...
- [NServiceBus (⭐2.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/Particular/NServiceBus) ![GitHub last commit](https://img.shields.io/github/last-commit/Particular/NServiceBus)](https://github.com/Particular/NServiceBus) - A .NET-based service bus that offers an intuitive developer-friendly environment.
...
- [Apache NiFi (⭐5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/nifi) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/nifi)](https://github.com/apache/nifi) - An automated data integration platform that efficiently moves data between disparate systems.
...
- [Pentaho Data Integration (⭐7.8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/pentaho/pentaho-kettle) ![GitHub last commit](https://img.shields.io/github/last-commit/pentaho/pentaho-kettle)](https://github.com/pentaho/pentaho-kettle) - A user-friendly platform that enables users to ingest, blend, cleanse, and prepare diverse data from any source with visual tools, eliminating the need for coding and complexity.
...
- [Apache Camel (⭐5.7k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/camel) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/camel)](https://github.com/apache/camel) - A powerful integration framework that uses Enterprise Integration Patterns to connect and unify different transport APIs.
- [Ballerina (⭐3.7k) ![GitHub Repo Stars](https://img.shields.io/github/stars/ballerina-platform/ballerina-lang) ![GitHub last commit](https://img.shields.io/github/last-commit/ballerina-platform/ballerina-lang)](https://github.com/ballerina-platform/ballerina-lang) - An open-source programming language that simplifies the creation, usage, and combination of network services.
- [Frank!Framework (⭐136) ![GitHub Repo Stars](https://img.shields.io/github/stars/frankframework/frankframework) ![GitHub last commit](https://img.shields.io/github/last-commit/frankframework/frankframework)](https://github.com/frankframework/frankframework) - A Low-Code Java-based messaging framework to connect your system and application data, that is completely configurable through XML configurations.
...
- [NATS (⭐16k) ![GitHub Repo Stars](https://img.shields.io/github/stars/nats-io/gnatsd) ![GitHub last commit](https://img.shields.io/github/last-commit/nats-io/gnatsd)](https://github.com/nats-io/gnatsd) - A lightweight and high-performance messaging system designed for microservices, IoT, and cloud-native systems. Offers efficient and reliable message delivery and supports multiple messaging protocols.
...
- [RabbitMQ (⭐12k) ![GitHub Repo Stars](https://img.shields.io/github/stars/rabbitmq/rabbitmq-server) ![GitHub last commit](https://img.shields.io/github/last-commit/rabbitmq/rabbitmq-server)](https://github.com/rabbitmq/rabbitmq-server) - An open-source message broker that implements AMQP and supports multiple messaging protocols and patterns. Offers reliable and efficient message delivery and supports clustering and high availability.
- [Redpanda (⭐9.9k) ![GitHub Repo Stars](https://img.shields.io/github/stars/vectorizedio/redpanda) ![GitHub last commit](https://img.shields.io/github/last-commit/vectorizedio/redpanda)](https://github.com/vectorizedio/redpanda) - A streaming platform that is Kafka-compatible and does not require Zookeeper or JVM. Offers high-performance and low-latency messaging and supports stream processing and analytics.
...
- [Activiti (⭐10k) ![GitHub Repo Stars](https://img.shields.io/github/stars/Activiti/Activiti) ![GitHub last commit](https://img.shields.io/github/last-commit/Activiti/Activiti)](https://github.com/Activiti/Activiti) - A lightweight and Java-centric open-source engine for executing BPMN (Business Process Model and Notation) workflows.
- [Apache Airflow (⭐38k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/airflow) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/airflow)](https://github.com/apache/airflow) - A platform that allows you to create, schedule, and monitor workflows programmatically, making it easier to manage and automate complex data pipelines.
- [Argo Workflows (⭐15k) ![GitHub Repo Stars](https://img.shields.io/github/stars/argoproj/argo-workflows) ![GitHub last commit](https://img.shields.io/github/last-commit/argoproj/argo-workflows)](https://github.com/argoproj/argo-workflows) - An open-source, container-native workflow engine designed to orchestrate parallel jobs on Kubernetes, making it easier to manage and automate complex workflows in a cloud-native environment.
- [Azkaban (⭐4.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/azkaban/azkaban) ![GitHub last commit](https://img.shields.io/github/last-commit/azkaban/azkaban)](https://github.com/azkaban/azkaban) - A distributed workflow manager that helps solve the problem of Hadoop job dependencies, making it easier to schedule and manage workflows in large-scale data processing environments.
- [Bonita (⭐161) ![GitHub Repo Stars](https://img.shields.io/github/stars/bonitasoft/bonita-engine) ![GitHub last commit](https://img.shields.io/github/last-commit/bonitasoft/bonita-engine)](https://github.com/bonitasoft/bonita-engine) - An open-source BPMN engine that comes with a designer and optional development environment, making it easier to build and automate complex business processes.
- [Cadence (⭐8.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/uber/cadence) ![GitHub last commit](https://img.shields.io/github/last-commit/uber/cadence)](https://github.com/uber/cadence) - A fault-tolerant, stateful code platform that makes it easier to build and manage complex, long-running applications.
- [Camunda (⭐4.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/camunda/camunda-bpm-platform) ![GitHub last commit](https://img.shields.io/github/last-commit/camunda/camunda-bpm-platform)](https://github.com/camunda/camunda-bpm-platform) - An open-source workflow and decision automation platform that helps you automate business processes and decisions in a flexible and scalable way.
- [Conductor (⭐12k) ![GitHub Repo Stars](https://img.shields.io/github/stars/Netflix/conductor) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/conductor)](https://github.com/Netflix/conductor) - A cloud-based orchestration engine designed to run and manage workflows in a microservices architecture.
- [Elsa Core (⭐6.8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/elsa-workflows/elsa-core) ![GitHub last commit](https://img.shields.io/github/last-commit/elsa-workflows/elsa-core)](https://github.com/elsa-workflows/elsa-core) - A library that enables workflow execution in any .NET Core application, making it easier to automate business processes in .NET environments.
- [Flowable (⭐8.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/flowable/flowable-engine) ![GitHub last commit](https://img.shields.io/github/last-commit/flowable/flowable-engine)](https://github.com/flowable/flowable-engine) - A set of open-source business process engines that are compact and efficient, making it easier to automate business processes in a scalable and reliable way.
- [jBPM (⭐1.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/kiegroup/jbpm) ![GitHub last commit](https://img.shields.io/github/last-commit/kiegroup/jbpm)](https://github.com/kiegroup/jbpm) - A toolkit for building business applications that helps you automate business processes and decisions, making it easier to manage complex workflows.
- [StackStorm (⭐6.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/StackStorm/st2) ![GitHub last commit](https://img.shields.io/github/last-commit/StackStorm/st2)](https://github.com/StackStorm/st2) - A robust automation engine that provides sensors, triggers, rules, workflows, and actions to help you automate and orchestrate complex workflows and applications.
- [Temporal (⭐12k) ![GitHub Repo Stars](https://img.shields.io/github/stars/temporalio/temporal) ![GitHub last commit](https://img.shields.io/github/last-commit/temporalio/temporal)](https://github.com/temporalio/temporal) - An open-source platform that uses a workflow-as-code approach to make your applications more reliable and scalable. 
...
- [API-led Connectivity pattern ![GitHub Repo Stars](https://img.shields.io/github/stars/chanakaudaya/solution-architecture-patterns) ![GitHub last commit](https://img.shields.io/github/last-commit/chanakaudaya/solution-architecture-patterns)](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/API-led-Connectivity-Pattern.md) - Use APIs to connect different systems and applications.
- [Anti Corruption Layer Pattern ![GitHub Repo Stars](https://img.shields.io/github/stars/chanakaudaya/solution-architecture-patterns) ![GitHub last commit](https://img.shields.io/github/last-commit/chanakaudaya/solution-architecture-patterns)](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Anti-Corruption-Layer-Pattern.md) - Add a layer to isolate and transform data between systems.
- [Change Data Capture Pattern ![GitHub Repo Stars](https://img.shields.io/github/stars/chanakaudaya/solution-architecture-patterns) ![GitHub last commit](https://img.shields.io/github/last-commit/chanakaudaya/solution-architecture-patterns)](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Introduction-to-Change-Data-Capture.md) - Capture and propagate changes made to a database or data source in real-time.
- [Hybrid API Management pattern ![GitHub Repo Stars](https://img.shields.io/github/stars/chanakaudaya/solution-architecture-patterns) ![GitHub last commit](https://img.shields.io/github/last-commit/chanakaudaya/solution-architecture-patterns)](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Hybrid-API-Management-Pattern.md) - Manage APIs that span both cloud and on-premises environments using a central control plane.
- [Hybrid Integration pattern ![GitHub Repo Stars](https://img.shields.io/github/stars/chanakaudaya/solution-architecture-patterns) ![GitHub last commit](https://img.shields.io/github/last-commit/chanakaudaya/solution-architecture-patterns)](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Hybrid-Integration-Pattern.md) - Integrate systems and applications that are deployed both on-premises and in the cloud using a combination of integration technologies.
...
### API Specification
- [API Blueprint (⭐8.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apiaryio/api-blueprint) ![GitHub last commit](https://img.shields.io/github/last-commit/apiaryio/api-blueprint)](https://github.com/apiaryio/api-blueprint) - A powerful high-level language for designing and documenting APIs that allows software engineers to easily collaborate and create efficient APIs.
- [AsyncAPI (⭐4.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/asyncapi/spec) ![GitHub last commit](https://img.shields.io/github/last-commit/asyncapi/spec)](https://github.com/asyncapi/spec) - An essential tool for developing Event-Driven Architectures (EDA) and enables engineers to build a better tooling ecosystem.
- [CloudEvents (⭐5.2k) ![GitHub Repo Stars](https://img.shields.io/github/stars/cloudevents/spec) ![GitHub last commit](https://img.shields.io/github/last-commit/cloudevents/spec)](https://github.com/cloudevents/spec) -  A specification for describing event data in common formats to provide interoperability across services, platforms and systems.
- [GraphQL (⭐14k) ![GitHub Repo Stars](https://img.shields.io/github/stars/graphql/graphql-spec) ![GitHub last commit](https://img.shields.io/github/last-commit/graphql/graphql-spec)](https://github.com/graphql/graphql-spec) - A sophisticated query language and runtime for building efficient APIs that empowers engineers to retrieve data from existing systems with ease.
- [JSON:API (⭐7.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/json-api/json-api) ![GitHub last commit](https://img.shields.io/github/last-commit/json-api/json-api)](https://github.com/json-api/json-api) - A standardized specification for building APIs that simplifies the representation of resources, relationships, and metadata, making it easier for software engineers to create efficient APIs.
- [OpenAPI (ex.Swagger) (⭐29k) ![GitHub Repo Stars](https://img.shields.io/github/stars/OAI/OpenAPI-Specification) ![GitHub last commit](https://img.shields.io/github/last-commit/OAI/OpenAPI-Specification)](https://github.com/OAI/OpenAPI-Specification) - A language-agnostic specification for creating RESTful APIs that enables both humans and machines to understand the capabilities of a service without the need for source code or documentation.
- [RAML (⭐3.8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/raml-org/raml-spec) ![GitHub last commit](https://img.shields.io/github/last-commit/raml-org/raml-spec)](https://github.com/raml-org/raml-spec) - A RESTful API Modeling Language that allows software engineers to design and create efficient APIs by modeling resources, endpoints, and interactions.
- [Standard Webhooks (⭐1.3k) ![GitHub Repo Stars](https://img.shields.io/github/stars/standard-webhooks/standard-webhooks) ![GitHub last commit](https://img.shields.io/github/last-commit/standard-webhooks/standard-webhooks)](https://github.com/standard-webhooks/standard-webhooks) - Open source tools and guidelines for sending webhooks easily, securely, and reliably.
...
<!--lint enable-->
### Articles
- [API-Security-Checklist (⭐22k) ![GitHub Repo Stars](https://img.shields.io/github/stars/shieldfy/API-Security-Checklist) ![GitHub last commit](https://img.shields.io/github/last-commit/shieldfy/API-Security-Checklist)](https://github.com/shieldfy/API-Security-Checklist) - Best practices about REST API security.
...
- [NDJSON (⭐706) ![GitHub Repo Stars](https://img.shields.io/github/stars/ndjson/ndjson-spec) ![GitHub last commit](https://img.shields.io/github/last-commit/ndjson/ndjson-spec)](https://github.com/ndjson/ndjson-spec) - A standard for delimiting JSON objects in stream protocols. It allows for efficient processing of large JSON datasets and is widely used in big data processing.
- [Protocol Buffers (⭐66k) ![GitHub Repo Stars](https://img.shields.io/github/stars/protocolbuffers/protobuf) ![GitHub last commit](https://img.shields.io/github/last-commit/protocolbuffers/protobuf)](https://github.com/protocolbuffers/protobuf) - A language-neutral and platform-neutral serialization mechanism that is designed to be highly efficient and extensible. It supports rich data types and is widely used in distributed systems, such as gRPC and Apache Kafka.
...
- [OpenMessaging (⭐288) ![GitHub Repo Stars](https://img.shields.io/github/stars/openmessaging/specification) ![GitHub last commit](https://img.shields.io/github/last-commit/openmessaging/specification)](https://github.com/openmessaging/specification) - A cloud native, vendor-neutral open specification for distributed messaging.
...
- [JSON Schema (⭐4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/json-schema-org/json-schema-spec) ![GitHub last commit](https://img.shields.io/github/last-commit/json-schema-org/json-schema-spec)](https://github.com/json-schema-org/json-schema-spec) - A powerful tool for validating the structure of JSON data. JSON Schema enables developers to ensure that JSON data conforms to a specific structure, making it easier to process and manipulate.
