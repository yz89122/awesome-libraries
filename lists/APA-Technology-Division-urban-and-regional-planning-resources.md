...
- [Madina ![GitHub Repo Stars](https://img.shields.io/github/stars/City-Form-Lab/madina) ![GitHub last commit](https://img.shields.io/github/last-commit/City-Form-Lab/madina)](https://github.com/City-Form-Lab/madina) - Madina is a package of classes and functions to streamline the representation and analysis of urban networks. This library includes a python implementation of the Urban Network Analysis Tools. 
...
- [ai-collection ![GitHub Repo Stars](https://img.shields.io/github/stars/ai-collection/ai-collection) ![GitHub last commit](https://img.shields.io/github/last-commit/ai-collection/ai-collection)](https://github.com/ai-collection/ai-collection) - Review of the generative AI landscape including tools/utilities.
