...
- [vfetch ![GitHub Repo Stars](https://img.shields.io/github/stars/carlosqsilva/vfetch) ![GitHub last commit](https://img.shields.io/github/last-commit/carlosqsilva/vfetch)](https://github.com/carlosqsilva/vfetch) - A macOS system information fetch written in V.
...
- [crayon ![GitHub Repo Stars](https://img.shields.io/github/stars/thecodrr/crayon) ![GitHub last commit](https://img.shields.io/github/last-commit/thecodrr/crayon)](https://github.com/thecodrr/crayon) - Paint your terminal output like Picasso. 🖍���🎨
