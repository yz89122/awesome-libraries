...
- **Tools**:
  ...
  - [Lambda Soup ![GitHub Repo Stars](https://img.shields.io/github/stars/aantron/lambda-soup) ![GitHub last commit](https://img.shields.io/github/last-commit/aantron/lambda-soup)](https://github.com/aantron/lambda-soup) - Functional HTML scraping and manipulation with CSS selectors, �� la Python's Beautiful Soup.
