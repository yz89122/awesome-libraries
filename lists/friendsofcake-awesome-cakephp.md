...
- [BryanCrowe/ApiPagination plugin ![GitHub Repo Stars](https://img.shields.io/github/stars/bcrowe/cakephp-api-pagination) ![GitHub last commit](https://img.shields.io/github/last-commit/bcrowe/cakephp-api-pagination)](https://github.com/bcrowe/cakephp-api-pagination) - Automatically adds fully configurable pagination metadata from CakePHP’s built-in pagination to JsonView or XmlView API responses by encapsulating payload data in an envelope.
