...
- [modbus-serial ![GitHub Repo Stars](https://img.shields.io/github/stars/yaacov/node-modbus-serial) ![GitHub last commit](https://img.shields.io/github/last-commit/yaacov/node-modbus-serial)](https://github.com/yaacov/node-modbus-serial) - A pure JavaScript implementation of MODBUS-RTU (serial and TCP).
...
- Other
	...
	- [Keyv ![GitHub Repo Stars](https://img.shields.io/github/stars/jaredwray/keyv) ![GitHub last commit](https://img.shields.io/github/last-commit/jaredwray/keyv)](https://github.com/jaredwray/keyv) - Simple key-value storage with support for multiple backends.
...
- [nyc ![GitHub Repo Stars](https://img.shields.io/github/stars/istanbuljs/nyc) ![GitHub last commit](https://img.shields.io/github/last-commit/istanbuljs/nyc)](https://github.com/istanbuljs/nyc) - Code coverage tool built on istanbul that works with subprocesses.
- [tap ![GitHub Repo Stars](https://img.shields.io/github/stars/tapjs/node-tap) ![GitHub last commit](https://img.shields.io/github/last-commit/tapjs/node-tap)](https://github.com/tapjs/node-tap) - TAP test framework.
...
- [Nock ![GitHub Repo Stars](https://img.shields.io/github/stars/nock/nock) ![GitHub last commit](https://img.shields.io/github/last-commit/nock/nock)](https://github.com/nock/nock) - HTTP mocking and expectations.
...
- [CodeceptJS ![GitHub Repo Stars](https://img.shields.io/github/stars/codeceptjs/CodeceptJS) ![GitHub last commit](https://img.shields.io/github/last-commit/codeceptjs/CodeceptJS)](https://github.com/codeceptjs/CodeceptJS) - End-to-end testing.
- [Puppeteer ![GitHub Repo Stars](https://img.shields.io/github/stars/puppeteer/puppeteer) ![GitHub last commit](https://img.shields.io/github/last-commit/puppeteer/puppeteer)](https://github.com/puppeteer/puppeteer) - Headless Chrome.
...
- [babel-minify ![GitHub Repo Stars](https://img.shields.io/github/stars/babel/minify) ![GitHub last commit](https://img.shields.io/github/last-commit/babel/minify)](https://github.com/babel/minify) - ES2015+ aware minifier based on the Babel toolchain.
- [UglifyJS2 ![GitHub Repo Stars](https://img.shields.io/github/stars/mishoo/UglifyJS) ![GitHub last commit](https://img.shields.io/github/last-commit/mishoo/UglifyJS)](https://github.com/mishoo/UglifyJS) - JavaScript minifier.
- [clean-css ![GitHub Repo Stars](https://img.shields.io/github/stars/clean-css/clean-css) ![GitHub last commit](https://img.shields.io/github/last-commit/clean-css/clean-css)](https://github.com/clean-css/clean-css) - CSS minifier.
...
- [Nodemailer ![GitHub Repo Stars](https://img.shields.io/github/stars/nodemailer/nodemailer) ![GitHub last commit](https://img.shields.io/github/last-commit/nodemailer/nodemailer)](https://github.com/nodemailer/nodemailer) - The fastest way to handle email.
...
- [agenda ![GitHub Repo Stars](https://img.shields.io/github/stars/agenda/agenda) ![GitHub last commit](https://img.shields.io/github/last-commit/agenda/agenda)](https://github.com/agenda/agenda) - MongoDB-backed job scheduling.
...
- [node-resque ![GitHub Repo Stars](https://img.shields.io/github/stars/actionhero/node-resque) ![GitHub last commit](https://img.shields.io/github/last-commit/actionhero/node-resque)](https://github.com/actionhero/node-resque) - Redis-backed job queue.
...
- [retext ![GitHub Repo Stars](https://img.shields.io/github/stars/retextjs/retext) ![GitHub last commit](https://img.shields.io/github/last-commit/retextjs/retext)](https://github.com/retextjs/retext) - An extensible natural language system.
...
- [Acorn ![GitHub Repo Stars](https://img.shields.io/github/stars/acornjs/acorn) ![GitHub last commit](https://img.shields.io/github/last-commit/acornjs/acorn)](https://github.com/acornjs/acorn) - Tiny, fast JavaScript parser.
...
- [docsify ![GitHub Repo Stars](https://img.shields.io/github/stars/docsifyjs/docsify) ![GitHub last commit](https://img.shields.io/github/last-commit/docsifyjs/docsify)](https://github.com/docsifyjs/docsify) - Markdown documentation site generator with no statically built HTML files.
...
- [protobuf ![GitHub Repo Stars](https://img.shields.io/github/stars/protobufjs/protobuf.js) ![GitHub last commit](https://img.shields.io/github/last-commit/protobufjs/protobuf.js)](https://github.com/protobufjs/protobuf.js) - Implementation of Protocol Buffers.
...
- [Node.js Best Practices ![GitHub Repo Stars](https://img.shields.io/github/stars/goldbergyoni/nodebestpractices) ![GitHub last commit](https://img.shields.io/github/last-commit/goldbergyoni/nodebestpractices)](https://github.com/goldbergyoni/nodebestpractices) - Summary and curation of the top-ranked content on Node.js best practices, available in multiple languages.
...
- [The Node Way ![GitHub Repo Stars](https://img.shields.io/github/stars/FredKSchott/the-node-way) ![GitHub last commit](https://img.shields.io/github/last-commit/FredKSchott/the-node-way)](https://github.com/FredKSchott/the-node-way) - An entire philosophy of Node.js best practices and guiding principles exists for writing maintainable modules, scalable applications, and code that is actually pleasant to read.
...
- [Portable Node.js guide ![GitHub Repo Stars](https://img.shields.io/github/stars/ehmicky/cross-platform-node-guide) ![GitHub last commit](https://img.shields.io/github/last-commit/ehmicky/cross-platform-node-guide)](https://github.com/ehmicky/cross-platform-node-guide) - Practical guide on how to write portable/cross-platform Node.js code.
...
- [Express.js ![GitHub Repo Stars](https://img.shields.io/github/stars/azat-co/cheatsheets) ![GitHub last commit](https://img.shields.io/github/last-commit/azat-co/cheatsheets)](https://github.com/azat-co/cheatsheets/tree/master/express4)
...
- [Amplication ![GitHub Repo Stars](https://img.shields.io/github/stars/amplication/amplication) ![GitHub last commit](https://img.shields.io/github/last-commit/amplication/amplication)](https://github.com/amplication/amplication) - Auto-generates fully functional apps.
...
- [Module Requests & Ideas ![GitHub Repo Stars](https://img.shields.io/github/stars/sindresorhus/project-ideas) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/project-ideas)](https://github.com/sindresorhus/project-ideas) - Request a JavaScript module you wish existed or get ideas for modules.
