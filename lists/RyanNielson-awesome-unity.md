...
Suggestions and contributions are always welcome! Make sure to read the [contribution guidelines ![GitHub Repo Stars](https://img.shields.io/github/stars/RyanNielson/awesome-unity) ![GitHub last commit](https://img.shields.io/github/last-commit/RyanNielson/awesome-unity)](https://github.com/RyanNielson/awesome-unity/blob/master/CONTRIBUTING.md) for more information before submitting a pull request.

Thanks to all the [contributors ![GitHub Repo Stars](https://img.shields.io/github/stars/ryannielson/awesome-unity) ![GitHub last commit](https://img.shields.io/github/last-commit/ryannielson/awesome-unity)](https://github.com/ryannielson/awesome-unity/graphs/contributors), this wouldn't be possible without you!
...
* [Pixel Camera 2D ![GitHub Repo Stars](https://img.shields.io/github/stars/RyanNielson/PixelCamera2D) ![GitHub last commit](https://img.shields.io/github/last-commit/RyanNielson/PixelCamera2D)](https://github.com/RyanNielson/PixelCamera2D) - A simple pixel perfect camera with scaling options for 2D Games.
...
* [UnityTiled ![GitHub Repo Stars](https://img.shields.io/github/stars/nickgravelyn/UnityTiled) ![GitHub last commit](https://img.shields.io/github/last-commit/nickgravelyn/UnityTiled)](https://github.com/nickgravelyn/UnityTiled) - An importer for [Tiled](http://www.mapeditor.org) maps.
...
* [Crystal AI ![GitHub Repo Stars](https://img.shields.io/github/stars/igiagkiozis/CrystalAI) ![GitHub last commit](https://img.shields.io/github/last-commit/igiagkiozis/CrystalAI)](https://github.com/igiagkiozis/CrystalAI) - Crystal is a fast, scalable and extensible utility based AI framework for C# and Unity.
...
* [Virtual Reality Toolkit ![GitHub Repo Stars](https://img.shields.io/github/stars/thestonefox/vrtk) ![GitHub last commit](https://img.shields.io/github/last-commit/thestonefox/vrtk)](http://github.com/thestonefox/vrtk) - Virtual Reality framework that allows for powerful interactions, locomotion, and visual effects.
...
* [CharacterController2D ![GitHub Repo Stars](https://img.shields.io/github/stars/prime31/CharacterController2D) ![GitHub last commit](https://img.shields.io/github/last-commit/prime31/CharacterController2D)](https://github.com/prime31/CharacterController2D) - A 2D controller that behaves very similarly to Unity's CharacterController component.

## Frameworks

* [Fungus ![GitHub Repo Stars](https://img.shields.io/github/stars/snozbot/fungus) ![GitHub last commit](https://img.shields.io/github/last-commit/snozbot/fungus)](https://github.com/snozbot/fungus) - An easy to use Unity 3D library for creating illustrated Interactive Fiction games.
...
* [InControl ![GitHub Repo Stars](https://img.shields.io/github/stars/pbhogan/InControl) ![GitHub last commit](https://img.shields.io/github/last-commit/pbhogan/InControl)](https://github.com/pbhogan/InControl) - An input manager that tames makes handler cross-platform. controller input easy.
* [InputBinder ![GitHub Repo Stars](https://img.shields.io/github/stars/RyanNielson/InputBinder) ![GitHub last commit](https://img.shields.io/github/last-commit/RyanNielson/InputBinder)](https://github.com/RyanNielson/InputBinder) - Bind game inputs to methods via code or using the inspector to add event driven input handling to your project.
* [TouchKit ![GitHub Repo Stars](https://img.shields.io/github/stars/prime31/TouchKit) ![GitHub last commit](https://img.shields.io/github/last-commit/prime31/TouchKit)](https://github.com/prime31/TouchKit) - Makes it easy to recognize gestures and other touch input.
* [TouchScript ![GitHub Repo Stars](https://img.shields.io/github/stars/TouchScript/TouchScript) ![GitHub last commit](https://img.shields.io/github/last-commit/TouchScript/TouchScript)](https://github.com/TouchScript/TouchScript) - Makes handling complex gesture interactions on any touch surface much easier.
...
* [Nakama](https://assetstore.unity.com/packages/tools/network/nakama-81338) - Build social and realtime games with an open-source [distributed server ![GitHub Repo Stars](https://img.shields.io/github/stars/heroiclabs/nakama) ![GitHub last commit](https://img.shields.io/github/last-commit/heroiclabs/nakama)](https://github.com/heroiclabs/nakama).
...
* [GoKit ![GitHub Repo Stars](https://img.shields.io/github/stars/prime31/GoKit) ![GitHub last commit](https://img.shields.io/github/last-commit/prime31/GoKit)](https://github.com/prime31/GoKit) - An open source, lightweight tween library aimed at making tweening objects dead simple.
...
* [Consolation ![GitHub Repo Stars](https://img.shields.io/github/stars/mminer/consolation) ![GitHub last commit](https://img.shields.io/github/last-commit/mminer/consolation)](https://github.com/mminer/consolation) - In-game debug console that displays output from `Debug.Log`.
...
* [Scene View Bookmarks ![GitHub Repo Stars](https://img.shields.io/github/stars/mminer/scene-view-bookmarks) ![GitHub last commit](https://img.shields.io/github/last-commit/mminer/scene-view-bookmarks)](https://github.com/mminer/scene-view-bookmarks) - Editor extension to bookmark and later recall scene views.
...
* [UniRx ![GitHub Repo Stars](https://img.shields.io/github/stars/neuecc/UniRx) ![GitHub last commit](https://img.shields.io/github/last-commit/neuecc/UniRx)](https://github.com/neuecc/UniRx) - UniRx (Reactive Extensions for Unity) is a reimplementation of the .NET Reactive Extensions. Rx cures the "asynchronous blues" without async/await.
* [UnityToolbag ![GitHub Repo Stars](https://img.shields.io/github/stars/nickgravelyn/unitytoolbag) ![GitHub last commit](https://img.shields.io/github/last-commit/nickgravelyn/unitytoolbag)](https://github.com/nickgravelyn/unitytoolbag) - Collection of miscellaneous open source scripts and helpers for Unity 5.0.

## Video

* [Vimeo Unity SDK ![GitHub Repo Stars](https://img.shields.io/github/stars/vimeo/vimeo-unity-sdk) ![GitHub last commit](https://img.shields.io/github/last-commit/vimeo/vimeo-unity-sdk)](https://github.com/vimeo/vimeo-unity-sdk) - Easily stream your Vimeo videos into Unity or record and publish out to Vimeo.
...
* [Nodulus ![GitHub Repo Stars](https://img.shields.io/github/stars/Hyperparticle/nodulus) ![GitHub last commit](https://img.shields.io/github/last-commit/Hyperparticle/nodulus)](https://github.com/Hyperparticle/nodulus) - A complete puzzle game with a clever twist. Play it online.
...
* [Unity Labs' Super Science ![GitHub Repo Stars](https://img.shields.io/github/stars/Unity-Technologies/SuperScience) ![GitHub last commit](https://img.shields.io/github/last-commit/Unity-Technologies/SuperScience)](https://github.com/Unity-Technologies/SuperScience) - Gems of Unity Labs for user education.
...
# Contributing
Please see [CONTRIBUTING ![GitHub Repo Stars](https://img.shields.io/github/stars/RyanNielson/awesome-unity) ![GitHub last commit](https://img.shields.io/github/last-commit/RyanNielson/awesome-unity)](https://github.com/RyanNielson/awesome-unity/blob/master/CONTRIBUTING.md) for details.
