...
* [On the Complexity of Bayesian Generalization](https://proceedings.mlr.press/v202/shi23i.html) - ***ICML'23***, 2023. [[All Versions](https://scholar.google.com/scholar?cluster=5817813824878811147)]. [[Code ![GitHub Repo Stars](https://img.shields.io/github/stars/SHI-Yu-Zhe/bayesian-generalization-complexity) ![GitHub last commit](https://img.shields.io/github/last-commit/SHI-Yu-Zhe/bayesian-generalization-complexity)](https://github.com/SHI-Yu-Zhe/bayesian-generalization-complexity)]. [[Models](https://drive.google.com/file/d/1eCuFqBYN8kuiAmoVtXWedXW0r0TdY55W/view)]. This work studies the two computation modes of concept generalization in the natural visual spectrum, *i.e.*, rule-based and similarity-based generalization, when the problem space scales up and when the complexity of concepts becomes diverse.
...
* [pix2code: Generating Code from a Graphical User Interface Screenshot](https://dl.acm.org/doi/abs/10.1145/3220134.3220135) - ***ACM SIGCHI Symposium on Engineering Interactive Computing Systems***, 2018. [[All Versions](https://scholar.google.com/scholar?cluster=8296741513177971931)]. [[Code ![GitHub Repo Stars](https://img.shields.io/github/stars/tonybeltramelli/pix2code) ![GitHub last commit](https://img.shields.io/github/last-commit/tonybeltramelli/pix2code)](https://github.com/tonybeltramelli/pix2code)]. [[Website](https://uizard.io/research/)]. This paper shows that deep learning methods can be leveraged to train a model end-to-end to automatically reverse engineer user interfaces and generate code from a single input image with over 77% of accuracy for three different platforms (i.e. iOS, Android and web-based technologies).
...
* [Errors are Useful Prompts: Instruction Guided Task Programming with Verifier-Assisted Iterative Prompting](https://arxiv.org/abs/2303.14100) - 2023. [[All Versions](https://scholar.google.com/scholar?cluster=8063693456660536915)]. [[Code ![GitHub Repo Stars](https://img.shields.io/github/stars/ac-rad/xdl-generation) ![GitHub last commit](https://img.shields.io/github/last-commit/ac-rad/xdl-generation)](https://github.com/ac-rad/xdl-generation)]. [[Website](https://ac-rad.github.io/clairify/)]. This paper proposes CLAIRIFY, an approach that combines automatic iterative prompting with program verification to ensure programs written in data-scarce domain-specific language are syntactically valid and incorporate environment constraints.
...
* [Learning to act by integrating mental simulations and physical experiments](https://cpilab.org/pubs/Dasgupta2018Learning.pdf) - ***CogSci'18***, 2018. [[All Versions](https://scholar.google.com/scholar?cluster=7342920174595829739&hl=en&as_sdt=0,5)]. [[Code ![GitHub Repo Stars](https://img.shields.io/github/stars/ishita-dg/SimulationVSAction) ![GitHub last commit](https://img.shields.io/github/last-commit/ishita-dg/SimulationVSAction)](https://github.com/ishita-dg/SimulationVSAction)].
...
* [SUNRISE: A Simple Unified Framework for Ensemble Learning in Deep Reinforcement Learning](http://proceedings.mlr.press/v139/lee21g.html) - ***ICML'21***, 2021. [[All Versions](https://scholar.google.com/scholar?cluster=8840831494454574191&hl=en&as_sdt=0,5)]. [[Code ![GitHub Repo Stars](https://img.shields.io/github/stars/pokaxpoka/sunrise) ![GitHub last commit](https://img.shields.io/github/last-commit/pokaxpoka/sunrise)](https://github.com/pokaxpoka/sunrise)].
...
* [TeachMyAgent: a Benchmark for Automatic Curriculum Learning in Deep RL](http://proceedings.mlr.press/v139/romac21a.html) - ***ICML'21***, 2021. [[All Versions](https://scholar.google.com/scholar?cluster=11016662361926634008&hl=en&as_sdt=0,5)]. [[Project ![GitHub Repo Stars](https://img.shields.io/github/stars/flowersteam/TeachMyAgent) ![GitHub last commit](https://img.shields.io/github/last-commit/flowersteam/TeachMyAgent)](https://github.com/flowersteam/TeachMyAgent)].
...
* [Grounded Language Learning Fast and Slow](https://arxiv.org/pdf/2009.01719.pdf) - ***ICLR'21***, 2021. [[All Versions](https://scholar.google.com/scholar?cluster=17735027444431750346&hl=en&as_sdt=0,5)]. [[Project ![GitHub Repo Stars](https://img.shields.io/github/stars/deepmind/dm_fast_mapping) ![GitHub last commit](https://img.shields.io/github/last-commit/deepmind/dm_fast_mapping)](https://github.com/deepmind/dm_fast_mapping?s=05)].
...
* [Deep Forest: Towards An Alternative to Deep Neural Networks](https://www.ijcai.org/Proceedings/2017/497) - ***IJCAI'17***, 2017. [[All Versions](https://scholar.google.com/scholar?cluster=7391596872731517007&hl=en&as_sdt=0,5)]. [[Project ![GitHub Repo Stars](https://img.shields.io/github/stars/LAMDA-NJU/Deep-Forest) ![GitHub last commit](https://img.shields.io/github/last-commit/LAMDA-NJU/Deep-Forest)](https://github.com/LAMDA-NJU/Deep-Forest)].

* [NBDT: Neural-Backed Decision Trees](https://arxiv.org/abs/2004.00221) - ***NeurIPS'20***, 2020. [[All Versions](https://scholar.google.com/scholar?cluster=1902399007162005819&hl=en&as_sdt=0,5)]. [[Code ![GitHub Repo Stars](https://img.shields.io/github/stars/alvinwan/neural-backed-decision-trees) ![GitHub last commit](https://img.shields.io/github/last-commit/alvinwan/neural-backed-decision-trees)](https://github.com/alvinwan/neural-backed-decision-trees)]. Expliciting the decision process of a decision tree through neural networks.

*[Back to Top](#c)

#### Explainable Deep Learning

* [pytorch-grad-cam ![GitHub Repo Stars](https://img.shields.io/github/stars/jacobgil/pytorch-grad-cam) ![GitHub last commit](https://img.shields.io/github/last-commit/jacobgil/pytorch-grad-cam)](https://github.com/jacobgil/pytorch-grad-cam) - 2021. Class Activation Map methods implemented in Pytorch, with many elegant features.
...
* [Compositional Explanations of Neurons](https://proceedings.neurips.cc/paper/2020/hash/c74956ffb38ba48ed6ce977af6727275-Abstract.html) - ***NeurIPS'20***, 2020. [[All Versions](https://scholar.google.com/scholar?cluster=15725346730266402738&hl=en&as_sdt=0,5)]. [[Project ![GitHub Repo Stars](https://img.shields.io/github/stars/jayelm/compexp) ![GitHub last commit](https://img.shields.io/github/last-commit/jayelm/compexp)](https://github.com/jayelm/compexp)]. A concept-composition version of network dissection.
...
* [Noise or Signal: The Role of Backgrounds in Image Classification](https://arxiv.org/pdf/2006.09994.pdf) - ***ICLR'21***, 2021. [[All Versions](https://scholar.google.com/scholar?cluster=14729938011425134088&hl=en&as_sdt=0,5)]. [[Code & Data ![GitHub Repo Stars](https://img.shields.io/github/stars/MadryLab/backgrounds_challenge) ![GitHub last commit](https://img.shields.io/github/last-commit/MadryLab/backgrounds_challenge)](https://github.com/MadryLab/backgrounds_challenge)]. [[Project](https://gradientscience.org/background/)]. A perspective on image background provides strong clue for foreground classification.
...
* [The Impact of Large Language Models on Scientific Discovery: a Preliminary Study using GPT-4](https://arxiv.org/abs/2311.07361) - ***Microsoft Research AI4Science***, 2023. [[All Versions]()]. [[Project ![GitHub Repo Stars](https://img.shields.io/github/stars/microsoft/LLM4ScientificDiscovery) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/LLM4ScientificDiscovery)](https://github.com/microsoft/LLM4ScientificDiscovery)]. A survey on the performance of LLMs within the context of scientific discovery, focusing on GPT-4.
...
* [Intuitive Physics Reading List ![GitHub Repo Stars](https://img.shields.io/github/stars/lishiqianhugh/Intuitive_Physics_Reading_List) ![GitHub last commit](https://img.shields.io/github/last-commit/lishiqianhugh/Intuitive_Physics_Reading_List)](https://github.com/lishiqianhugh/Intuitive_Physics_Reading_List) - ***GitHub***. A reading list on intuitive physics, maintained actively by Shiqian Li.
...
* [Towards Open World Object Detection](https://arxiv.org/pdf/2103.02603v1.pdf) - ***CVPR'21***, 2021. [[All Versions](https://scholar.google.com/scholar?cluster=9715328489246217151&hl=en&as_sdt=0,5)]. [[Project ![GitHub Repo Stars](https://img.shields.io/github/stars/JosephKJ/OWOD) ![GitHub last commit](https://img.shields.io/github/last-commit/JosephKJ/OWOD)](https://github.com/JosephKJ/OWOD)].
...
#### Dataset Aggregation
  * [A Dataset and Architecture for Visual Reasoning with a Working Memory](https://link.springer.com/chapter/10.1007%2F978-3-030-01249-6_44) - ***ECCV'18***, 2018. [[Project ![GitHub Repo Stars](https://img.shields.io/github/stars/google/cog) ![GitHub last commit](https://img.shields.io/github/last-commit/google/cog)](https://github.com/google/cog)].
...
##### Malmo Platform for Minecraft AI
  ...
  * [[Malmo ![GitHub Repo Stars](https://img.shields.io/github/stars/Microsoft/malmo) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/malmo)](https://github.com/Microsoft/malmo#getting-started)]. 
  * [[Malmo-env ![GitHub Repo Stars](https://img.shields.io/github/stars/Microsoft/malmo) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/malmo)](https://github.com/Microsoft/malmo/tree/master/MalmoEnv)]. 
  * [[Malmo-Tutorials](https://microsoft.github.io/malmo/0.17.0/Python_Examples/Tutorial.pdf)].
  * [[MineRL](https://minerl.io/)].
  * [[MarLo Challenge 2018 ![GitHub Repo Stars](https://img.shields.io/github/stars/crowdAI/marLo) ![GitHub last commit](https://img.shields.io/github/last-commit/crowdAI/marLo)](https://github.com/crowdAI/marLo)].
