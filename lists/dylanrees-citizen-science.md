 ...
 * [ISLE ![GitHub Repo Stars](https://img.shields.io/github/stars/nasa/isle) ![GitHub last commit](https://img.shields.io/github/last-commit/nasa/isle)](https://github.com/nasa/isle) - Open-source laboratory equipment inventory management system developed by NASA.
 ...
 * [RapidPro ![GitHub Repo Stars](https://img.shields.io/github/stars/rapidpro/rapidpro) ![GitHub last commit](https://img.shields.io/github/last-commit/rapidpro/rapidpro)](https://github.com/rapidpro/rapidpro) - An open-source platform for building scalable applications that users can interact with via SMS.
 ...
 * **Familiar with GitHub?** Send a pull request with your suggestions. Please also see the [contribution guidelines ![GitHub Repo Stars](https://img.shields.io/github/stars/dylanrees/toolsforcitizenscience) ![GitHub last commit](https://img.shields.io/github/last-commit/dylanrees/toolsforcitizenscience)](https://github.com/dylanrees/toolsforcitizenscience/blob/master/contributing.md).
