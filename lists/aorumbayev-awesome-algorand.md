...
- [Liquid Auth ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/liquid-auth) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/liquid-auth)](https://github.com/algorandfoundation/liquid-auth) - Liquid Auth is a self-hosted authentication service that provides a simple way to associate Passkeys to KeyPair(s) commonly found in cryptocurrencies. In addition to authentication, Liquid Auth provides a Peer to Peer signaling service. Not only can you authenticate users, but you can also establish secure connections between them.
...
- [algokit-python-template ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/algokit-python-template) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/algokit-python-template)](https://github.com/algorandfoundation/algokit-python-template) - Official AlgoKit's Algorand Python template provides a production-ready baseline for developing and deploying smart contracts in Python.
...
- [defly-connect ![GitHub Repo Stars](https://img.shields.io/github/stars/blockshake-io/defly-connect) ![GitHub last commit](https://img.shields.io/github/last-commit/blockshake-io/defly-connect)](https://github.com/blockshake-io/defly-connect) - JavaScript SDK for integrating Defly Wallet to web applications.
...
- [TEALrb ![GitHub Repo Stars](https://img.shields.io/github/stars/joe-p/TEALrb) ![GitHub last commit](https://img.shields.io/github/last-commit/joe-p/TEALrb)](https://github.com/joe-p/TEALrb) - A Ruby DSL for writing Algorand smart contracts. (Archived on Jan 22, 2023)
...
- [Algorand Sandbox Dev ![GitHub Repo Stars](https://img.shields.io/github/stars/MakerXStudio/algorand-sandbox-dev) ![GitHub last commit](https://img.shields.io/github/last-commit/MakerXStudio/algorand-sandbox-dev)](https://github.com/MakerXStudio/algorand-sandbox-dev) - Docker Hub image for faster local development and CI/CD usage. (Archived on Jan 2, 2024)
...
- [rsagg ![GitHub Repo Stars](https://img.shields.io/github/stars/dragmz/rsagg) ![GitHub last commit](https://img.shields.io/github/last-commit/dragmz/rsagg)](https://github.com/dragmz/rsagg) - A Rust library for GPU accelerated Algorand 'vanity' address generation.
...
- [TxnLab/reti ![GitHub Repo Stars](https://img.shields.io/github/stars/TxnLab/reti) ![GitHub last commit](https://img.shields.io/github/last-commit/TxnLab/reti)](https://github.com/TxnLab/reti) - Provides contracts, a Node Daemon, and a UI for Algorand 'The Reti' consensus incentives, facilitating the creation of decentralized staking pools on the Algorand network to promote broader participation and enhance network security through diversification.
...
- [QRCode Generator ![GitHub Repo Stars](https://img.shields.io/github/stars/emg110/algorand-qrcode) ![GitHub last commit](https://img.shields.io/github/last-commit/emg110/algorand-qrcode)](https://github.com/emg110/algorand-qrcode) - Uinversal QRCode generator module for Algorand ARC-26 URIs.
- [algofractals ![GitHub Repo Stars](https://img.shields.io/github/stars/aorumbayev/algofractals) ![GitHub last commit](https://img.shields.io/github/last-commit/aorumbayev/algofractals)](https://github.com/aorumbayev/algofractals) - Mint randomly generated mandelbrot fractals with embedded ARC69 tags. (Archived on Dec 31, 2023)
...
- [Pipeline-UI ![GitHub Repo Stars](https://img.shields.io/github/stars/headline-design/pipeline-ui) ![GitHub last commit](https://img.shields.io/github/last-commit/headline-design/pipeline-ui)](https://github.com/headline-design/pipeline-ui) - A React.js based component library for rapid deployment of Algorand Dapps.
...
- [Automated Prediction Market Maker on Algorand ![GitHub Repo Stars](https://img.shields.io/github/stars/dspytdao/Algo_AMM) ![GitHub last commit](https://img.shields.io/github/last-commit/dspytdao/Algo_AMM)](https://github.com/dspytdao/Algo_AMM) - backend repository with project hosted at [algoAMM.com](https://algoamm.com).
- [AlgoDepo ![GitHub Repo Stars](https://img.shields.io/github/stars/dspytdao/AlgoDepo) ![GitHub last commit](https://img.shields.io/github/last-commit/dspytdao/AlgoDepo)](https://github.com/dspytdao/AlgoDepo) - Single Deposit App Algorand.
- [AlgoDeposit ![GitHub Repo Stars](https://img.shields.io/github/stars/dspytdao/AlgoDeposit) ![GitHub last commit](https://img.shields.io/github/last-commit/dspytdao/AlgoDeposit)](https://github.com/dspytdao/AlgoDeposit) - AMM Pool App Algorand.
