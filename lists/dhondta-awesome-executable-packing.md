...
- :closed_book: [The art of memory forensics: Detecting malware and threats in Windows, Linux, and mac memory](https://www.oreilly.com/library/view/the-art-of/9781118824993)
...
- :newspaper: [A complexity measure](http://ieeexplore.ieee.org/document/1702388/)
...
- :question: [On the worst-case complexity of timsort](http://arxiv.org/abs/1805.08612)
...
- :bar_chart: [Packing-box: Breaking detectors & visualizing packing](https://www.blackhat.com/eu-23/arsenal/schedule#packing-box-breaking-detectors--visualizing-packing-35678)
...
- :bar_chart: [Packing-box: Playing with executable packing](https://www.blackhat.com/eu-22/arsenal/schedule#packing-box-playing-with-executable-packing-29054)
- :pushpin: [Parsing mach-O files](https://lowlevelbits.org/parsing-mach-o-files)
- :closed_book: [Pattern recognition and machine learning (Information science and statistics)](https://dl.acm.org/doi/10.5555/1162264)
...
- :closed_book: [Practical malware analysis: The hands-on guide to dissecting malicious software](https://www.oreilly.com/library/view/practical-malware-analysis/9781593272906)
...
- :question: [A survey of dimensionality reduction techniques](https://arxiv.org/abs/1403.2877)
...
- :question: [Assessing static and dynamic features for packing detection](https://doi.org/10.1007/978-3-031-73887-6_12) (October 2024)  :star:
...
- :question: [A compact multi-step framework for packing identification in portable executable files for malware analysis](https://www.researchsquare.com/article/rs-3974855/v1) (February 2024) 
...
- :question: [EMBER: An open dataset for training static PE malware machine learning models](https://arxiv.org/abs/1804.04637) (April 2018)  :star:
...
- :question: [Generic unpacking of self-modifying, aggressive, packed binary programs](https://arxiv.org/abs/0905.4581) (May 2009) 
...
- :question: [Learning to evade static PE machine learning malware models via reinforcement learning](https://arxiv.org/abs/1801.08917) (January 2018) 
...
- :question: [Novel feature extraction, selection and fusion for effective malware family classification](http://arxiv.org/abs/1511.04317) (March 2016) 
...
- :question: [Transcending transcend: Revisiting malware classification in the presence of concept drift](http://arxiv.org/abs/2010.03856) (December 2021) 
