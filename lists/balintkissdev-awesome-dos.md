...
- [SmallerC ![GitHub Repo Stars](https://img.shields.io/github/stars/alexfru/SmallerC.git) ![GitHub last commit](https://img.shields.io/github/last-commit/alexfru/SmallerC.git)](https://github.com/alexfru/SmallerC.git) - Portable self-hosting C compiler capable of producing executables for a number of platforms, including real and protected mode DOS programs, by Alexei A. Frounze.
- [Small-C Toolkit ![GitHub Repo Stars](https://img.shields.io/github/stars/humbertocsjr/Small-C.git) ![GitHub last commit](https://img.shields.io/github/last-commit/humbertocsjr/Small-C.git)](https://github.com/humbertocsjr/Small-C.git) - A self-hosting Small-C Compiler Toolkit for DOS(8086) with: K&R C Compiler, Make, Linker, Assembler. First released in 1982 by Jim E. Hendrix.

### Memory managers

- [386MAX ![GitHub Repo Stars](https://img.shields.io/github/stars/sudleyplace/386MAX) ![GitHub last commit](https://img.shields.io/github/last-commit/sudleyplace/386MAX)](https://github.com/sudleyplace/386MAX) - Memory manager for DOS PCs with 386 or higher CPUs, [released by Qualitas company in 1992](https://winworldpc.com/product/386max/6x). Source code was released in June 2022 on GitHub with GPL-3.0 license.
...
- [SBEMU ![GitHub Repo Stars](https://img.shields.io/github/stars/crazii/SBEMU) ![GitHub last commit](https://img.shields.io/github/last-commit/crazii/SBEMU)](https://github.com/crazii/SBEMU) - A TSR that emulates Sound Blaster and OPL3 in pure DOS using modern PCI-based (onboard and add-in card) sound cards. Supports both real mode and protected mode games!
- [VSB ![GitHub Repo Stars](https://img.shields.io/github/stars/Baron-von-Riedesel/VSBHDA) ![GitHub last commit](https://img.shields.io/github/last-commit/Baron-von-Riedesel/VSBHDA)](https://github.com/Baron-von-Riedesel/VSBHDA) - A fork of SBEMU (see above), which also aims to offer Sound Blaster emulation for modern PC hardware, in both real mode and protected mode games.
