...
* [About Swift ![GitHub Repo Stars](https://img.shields.io/github/stars/NicolaLancellotti/about-swift) ![GitHub last commit](https://img.shields.io/github/last-commit/NicolaLancellotti/about-swift)](https://github.com/NicolaLancellotti/about-swift) - A playground about the Swift language.
...
* [Swift Module Template ![GitHub Repo Stars](https://img.shields.io/github/stars/fulldecent/swift6-module-template) ![GitHub last commit](https://img.shields.io/github/last-commit/fulldecent/swift6-module-template)](https://github.com/fulldecent/swift6-module-template) - An opinionated starting point for awesome, reusable modules.
...
* [MusicKit ![GitHub Repo Stars](https://img.shields.io/github/stars/0thernet/MusicKit) ![GitHub last commit](https://img.shields.io/github/last-commit/0thernet/MusicKit)](https://github.com/0thernet/MusicKit) - A framework for composing and transforming music.
* [Soundable ![GitHub Repo Stars](https://img.shields.io/github/stars/lcardevnas/Soundable) ![GitHub last commit](https://img.shields.io/github/last-commit/lcardevnas/Soundable)](https://github.com/lcardevnas/Soundable) - Soundable allows you to play sounds, single and in sequence, in a very easy way.
...
* [ARKit-CoreLocation ![GitHub Repo Stars](https://img.shields.io/github/stars/AndrewHartAR/ARKit-CoreLocation) ![GitHub last commit](https://img.shields.io/github/last-commit/AndrewHartAR/ARKit-CoreLocation)](https://github.com/AndrewHartAR/ARKit-CoreLocation) - Combines the high accuracy of AR with the scale of GPS data.
...
* [SwiftCharts ![GitHub Repo Stars](https://img.shields.io/github/stars/ivnsch/SwiftCharts) ![GitHub last commit](https://img.shields.io/github/last-commit/ivnsch/SwiftCharts)](https://github.com/ivnsch/SwiftCharts) - Highly customizable charts for iOS.
...
* [CacheAdvance ![GitHub Repo Stars](https://img.shields.io/github/stars/dfed/CacheAdvance) ![GitHub last commit](https://img.shields.io/github/last-commit/dfed/CacheAdvance)](https://github.com/dfed/CacheAdvance) - A performant cache for logging systems. CacheAdvance persists log events 30x faster than SQLite.
...
* [Unrealm ![GitHub Repo Stars](https://img.shields.io/github/stars/matghazaryan/Unrealm) ![GitHub last commit](https://img.shields.io/github/last-commit/matghazaryan/Unrealm)](https://github.com/matghazaryan/Unrealm) - Unrealm enables you to easily store Swift native Classes, Structs and Enums into Realm.
...
* [XMLCoder ![GitHub Repo Stars](https://img.shields.io/github/stars/CoreOffice/XMLCoder) ![GitHub last commit](https://img.shields.io/github/last-commit/CoreOffice/XMLCoder)](https://github.com/CoreOffice/XMLCoder) - XMLEncoder & XMLDecoder based on Codable protocols from the standard library.
...
* [SafeDI ![GitHub Repo Stars](https://img.shields.io/github/stars/dfed/safedi) ![GitHub last commit](https://img.shields.io/github/last-commit/dfed/safedi)](https://github.com/dfed/safedi) - Compile-time safe dependency injection.
...
* [MijickCamera ![GitHub Repo Stars](https://img.shields.io/github/stars/Mijick/Camera) ![GitHub last commit](https://img.shields.io/github/last-commit/Mijick/Camera)](https://github.com/Mijick/Camera) - Camera made simple. Fully customizable camera library that significantly reduces implementation time and effort.
...
* [Brightroom ![GitHub Repo Stars](https://img.shields.io/github/stars/FluidGroup/Brightroom) ![GitHub last commit](https://img.shields.io/github/last-commit/FluidGroup/Brightroom)](https://github.com/FluidGroup/Brightroom) - An image editor and engine using CoreImage.
...
* [MCScratchImageView ![GitHub Repo Stars](https://img.shields.io/github/stars/JaylenCoding/MCScratchImageView) ![GitHub last commit](https://img.shields.io/github/last-commit/JaylenCoding/MCScratchImageView)](https://github.com/JaylenCoding/MCScratchImageView) - A custom ImageView that is used to cover the surface of other view like a scratch card, user can swipe the mulch to see the view below.
...
* [ZMarkupParser ![GitHub Repo Stars](https://img.shields.io/github/stars/ZhgChgLi/ZMarkupParser) ![GitHub last commit](https://img.shields.io/github/last-commit/ZhgChgLi/ZMarkupParser)](https://github.com/ZhgChgLi/ZMarkupParser) - Helps you convert HTML strings into NSAttributedString with customized styles and tags.
...
* [AnyLint ![GitHub Repo Stars](https://img.shields.io/github/stars/FlineDev/AnyLint) ![GitHub last commit](https://img.shields.io/github/last-commit/FlineDev/AnyLint)](https://github.com/FlineDev/AnyLint) :penguin: - Lint anything by combining the power of Swift & regular expressions.
...
* [Valet ![GitHub Repo Stars](https://img.shields.io/github/stars/square/Valet) ![GitHub last commit](https://img.shields.io/github/last-commit/square/Valet)](https://github.com/square/Valet) - Valet lets you securely store data in the Keychain without knowing a thing about how the Keychain works. It’s easy. We promise.
...
* [LaunchAtLogin ![GitHub Repo Stars](https://img.shields.io/github/stars/sindresorhus/LaunchAtLogin-Legacy) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/LaunchAtLogin-Legacy)](https://github.com/sindresorhus/LaunchAtLogin-Legacy) - Easily add 'Launch at Login' functionality to your sandboxed macOS app.
...
* [swift-testing-expectation ![GitHub Repo Stars](https://img.shields.io/github/stars/dfed/swift-testing-expectation) ![GitHub last commit](https://img.shields.io/github/last-commit/dfed/swift-testing-expectation)](https://github.com/dfed/swift-testing-expectation) - Create an asynchronous expectation in Swift Testing.
...
* [XCTest ![GitHub Repo Stars](https://img.shields.io/github/stars/swiftlang/swift-corelibs-xctest) ![GitHub last commit](https://img.shields.io/github/last-commit/swiftlang/swift-corelibs-xctest)](https://github.com/swiftlang/swift-corelibs-xctest) - The XCTest Project, A Swift core library for providing unit test support.
...
* [Preferences ![GitHub Repo Stars](https://img.shields.io/github/stars/sindresorhus/Settings) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/Settings)](https://github.com/sindresorhus/Settings) - Add a preferences window to your macOS app in minutes.
...
* [SweetCurtain ![GitHub Repo Stars](https://img.shields.io/github/stars/ihormalovanyi/SweetCurtain) ![GitHub last commit](https://img.shields.io/github/last-commit/ihormalovanyi/SweetCurtain)](https://github.com/ihormalovanyi/SweetCurtain) - Really sweet and easy bottom pullable sheet implementation. You can find a similar implementation in applications like Apple Maps, Find My, Stocks, etc.
* [SwiftUISkia ![GitHub Repo Stars](https://img.shields.io/github/stars/rustq/swiftui-skia) ![GitHub last commit](https://img.shields.io/github/last-commit/rustq/swiftui-skia)](https://github.com/rustq/swiftui-skia) - Skia based 2d graphics SwiftUI rendering library, based on Rust to implement software rasterization to perform rendering
...
* [MijickPopups ![GitHub Repo Stars](https://img.shields.io/github/stars/Mijick/Popups) ![GitHub last commit](https://img.shields.io/github/last-commit/Mijick/Popups)](https://github.com/Mijick/Popups) - Popups, popovers, sheets, alerts, toasts, banners, (...) presentation made simple.
...
* [SPAlert ![GitHub Repo Stars](https://img.shields.io/github/stars/sparrowcode/AlertKit) ![GitHub last commit](https://img.shields.io/github/last-commit/sparrowcode/AlertKit)](https://github.com/sparrowcode/AlertKit) - Native popup from Apple Music & Feedback in AppStore. Contains Done & Heart presets.
...
* [iPages ![GitHub Repo Stars](https://img.shields.io/github/stars/blsage/iPages) ![GitHub last commit](https://img.shields.io/github/last-commit/blsage/iPages)](https://github.com/blsage/iPages) - Quickly implement swipable page views in SwiftUI 📝.
...
* [SPPermission ![GitHub Repo Stars](https://img.shields.io/github/stars/sparrowcode/PermissionsKit) ![GitHub last commit](https://img.shields.io/github/last-commit/sparrowcode/PermissionsKit)](https://github.com/sparrowcode/PermissionsKit) - Simple request permission with native UI and interactive animation.
...
* [iTextField ⌨️ ![GitHub Repo Stars](https://img.shields.io/github/stars/blsage/iTextField) ![GitHub last commit](https://img.shields.io/github/last-commit/blsage/iTextField)](https://github.com/blsage/iTextField) - A fully-wrapped `UITextField` that works entirely in SwiftUI 🦅.
...
* [MijickNavigattie ![GitHub Repo Stars](https://img.shields.io/github/stars/Mijick/NavigationView) ![GitHub last commit](https://img.shields.io/github/last-commit/Mijick/NavigationView)](https://github.com/Mijick/NavigationView) - Easy navigation with SwiftUI.
...
* [WLEmptyState ![GitHub Repo Stars](https://img.shields.io/github/stars/WizelineLabs/WLEmptyState) ![GitHub last commit](https://img.shields.io/github/last-commit/WizelineLabs/WLEmptyState)](https://github.com/WizelineLabs/WLEmptyState) - A component that lets you customize the view when the dataset of UITableView is empty.
...
* [SuggestionsKit ![GitHub Repo Stars](https://img.shields.io/github/stars/AlphanumericCharactersOrSingleHyphenz/SuggestionsKit) ![GitHub last commit](https://img.shields.io/github/last-commit/AlphanumericCharactersOrSingleHyphenz/SuggestionsKit)](https://github.com/AlphanumericCharactersOrSingleHyphenz/SuggestionsKit) - Library for educating users about features in app.
...
* [SwiftTweaks ![GitHub Repo Stars](https://img.shields.io/github/stars/bryanjclark/SwiftTweaks) ![GitHub last commit](https://img.shields.io/github/last-commit/bryanjclark/SwiftTweaks)](https://github.com/bryanjclark/SwiftTweaks) - Tweak your iOS app without recompiling.
...
* [ZamzamKit ![GitHub Repo Stars](https://img.shields.io/github/stars/basememara/ZamzamKit) ![GitHub last commit](https://img.shields.io/github/last-commit/basememara/ZamzamKit)](https://github.com/basememara/ZamzamKit) - A collection of micro utilities and extensions for Standard Library, Foundation and UIKit.
