...
Sharing, suggestions and contributions are always welcome! Please take a look at the [contribution guidelines ![GitHub Repo Stars](https://img.shields.io/github/stars/zudochkin/awesome-newsletters) ![GitHub last commit](https://img.shields.io/github/last-commit/zudochkin/awesome-newsletters)](https://github.com/zudochkin/awesome-newsletters/blob/master/CONTRIBUTING.md) first.

Thanks to all [contributors ![GitHub Repo Stars](https://img.shields.io/github/stars/zudochkin/awesome-newsletters) ![GitHub last commit](https://img.shields.io/github/last-commit/zudochkin/awesome-newsletters)](https://github.com/zudochkin/awesome-newsletters/graphs/contributors).
...
- [R Weekly](https://rweekly.org). Weekly updates about R and Data Science. R Weekly is [openly developed on GitHub ![GitHub Repo Stars](https://img.shields.io/github/stars/rweekly/rweekly.org) ![GitHub last commit](https://img.shields.io/github/last-commit/rweekly/rweekly.org)](https://github.com/rweekly/rweekly.org).
...
- [GitHub Trending Repos ![GitHub Repo Stars](https://img.shields.io/github/stars/vitalets/github-trending-repos) ![GitHub last commit](https://img.shields.io/github/last-commit/vitalets/github-trending-repos)](https://github.com/vitalets/github-trending-repos). A special repo allowing to track trending projects in your favorite programming language on GitHub. Updates come as GitHub notifications once a day or a week.
