...
* [Shield ![GitHub Repo stars](https://img.shields.io/github/stars/cyx/shield) ![GitHub last commit](https://img.shields.io/github/last-commit/cyx/shield)](https://github.com/cyx/shield) - Authentication protocol for use in your routing and model context.
* [Sorcery ![GitHub Repo stars](https://img.shields.io/github/stars/Sorcery/sorcery) ![GitHub last commit](https://img.shields.io/github/last-commit/Sorcery/sorcery)](https://github.com/Sorcery/sorcery) - Magical Authentication for Rails 4, and Rails 5.
...
* [Hanami CLI ![GitHub Repo stars](https://img.shields.io/github/stars/hanami/cli) ![GitHub last commit](https://img.shields.io/github/last-commit/hanami/cli)](https://github.com/hanami/cli) - General purpose Command Line Interface (CLI) framework for Ruby.
...
* [Parallel ![GitHub Repo stars](https://img.shields.io/github/stars/grosser/parallel) ![GitHub last commit](https://img.shields.io/github/last-commit/grosser/parallel)](https://github.com/grosser/parallel) - Run any code in parallel Processes (> use all CPUs) or Threads (> speedup blocking operations).
...
* Attributes
  ...
  * [FastAttributes ![GitHub Repo stars](https://img.shields.io/github/stars/applift/fast_attributes) ![GitHub last commit](https://img.shields.io/github/last-commit/applift/fast_attributes)](https://github.com/applift/fast_attributes) - FastAttributes adds attributes with their types to the class.
...
* [Piggybak ![GitHub Repo stars](https://img.shields.io/github/stars/piggybak/piggybak) ![GitHub last commit](https://img.shields.io/github/last-commit/piggybak/piggybak)](https://github.com/piggybak/piggybak) - Modular, Extensible open-source ecommerce solution for Ruby on Rails.
...
* [Raven Ruby ![GitHub Repo stars](https://img.shields.io/github/stars/getsentry/raven-ruby) ![GitHub last commit](https://img.shields.io/github/last-commit/getsentry/raven-ruby)](https://github.com/getsentry/raven-ruby) - Raven is a Ruby client for Sentry.
...
* [HTTPX](https://gitlab.com/honeyryderchuck/httpx) - acknowledges the ease-of-use of the [http ![GitHub Repo stars](https://img.shields.io/github/stars/httprb/http) ![GitHub last commit](https://img.shields.io/github/last-commit/httprb/http)](https://github.com/httprb/http) gem API (itself inspired by python requests library) which aims at reusing the same facade, extending it for the use cases which the http gem doesn't support.
...
* [MongoDB Logger ![GitHub Repo stars](https://img.shields.io/github/stars/le0pard/mongodb_logger) ![GitHub last commit](https://img.shields.io/github/last-commit/le0pard/mongodb_logger)](https://github.com/le0pard/mongodb_logger) - MongoDB logger for Rails.
...
* [AXLSX ![GitHub Repo stars](https://img.shields.io/github/stars/randym/axlsx) ![GitHub last commit](https://img.shields.io/github/last-commit/randym/axlsx)](https://github.com/randym/axlsx) - An excel xlsx generation library.
...
* WebDrivers
  ...
  * [API Taster ![GitHub Repo stars](https://img.shields.io/github/stars/fredwu/api_taster) ![GitHub last commit](https://img.shields.io/github/last-commit/fredwu/api_taster)](https://github.com/fredwu/api_taster) - A quick and easy way to visually test your Rails application's API.
