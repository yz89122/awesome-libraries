...
* [graphql-request ![GitHub Repo stars](https://img.shields.io/github/stars/prisma/graphql-request) ![GitHub last commit](https://img.shields.io/github/last-commit/prisma/graphql-request)](https://github.com/prisma/graphql-request) - A minimal GraphQL client for Node and browsers.
...
* [FetchQL ![GitHub Repo stars](https://img.shields.io/github/stars/gucheen/FetchQL) ![GitHub last commit](https://img.shields.io/github/last-commit/gucheen/FetchQL)](https://github.com/gucheen/FetchQL) - A simple GraphQL query client using Fetch.
...
* [graphql-thinky ![GitHub Repo stars](https://img.shields.io/github/stars/fenos/graphql-thinky) ![GitHub last commit](https://img.shields.io/github/last-commit/fenos/graphql-thinky)](https://github.com/fenos/graphql-thinky) - Build an optimized GraphQL schema from Thinky RethinkDB models.
* [graphql-tools-sequelize ![GitHub Repo stars](https://img.shields.io/github/stars/rse/graphql-tools-sequelize) ![GitHub last commit](https://img.shields.io/github/last-commit/rse/graphql-tools-sequelize)](https://github.com/rse/graphql-tools-sequelize) - OO-style schema definition functions and schema resolver functions for GraphQL-Tools using Sequelize ORM
* [graysql-orm-loader ![GitHub Repo stars](https://img.shields.io/github/stars/larsbs/graysql-orm-loader) ![GitHub last commit](https://img.shields.io/github/last-commit/larsbs/graysql-orm-loader)](https://github.com/larsbs/graysql-orm-loader) - A GraysQL extension to load a GraphQL schema from an ORM.
* [fireQL ![GitHub Repo stars](https://img.shields.io/github/stars/Illuday/fireQL) ![GitHub last commit](https://img.shields.io/github/last-commit/Illuday/fireQL)](https://github.com/Illuday/fireQL) - A GraphQL API for Firebase (Firestore database), auto-hosted on cloud functions.
...
* [codemirror-graphql ![GitHub Repo stars](https://img.shields.io/github/stars/graphql/codemirror-graphql) ![GitHub last commit](https://img.shields.io/github/last-commit/graphql/codemirror-graphql)](https://github.com/graphql/codemirror-graphql) - GraphQL mode and helpers for CodeMirror.
* [graphql-schema ![GitHub Repo stars](https://img.shields.io/github/stars/devknoll/graphql-schema) ![GitHub last commit](https://img.shields.io/github/last-commit/devknoll/graphql-schema)](https://github.com/devknoll/graphql-schema) - Create GraphQL schemas with a fluent/chainable interface.
* [graphql-tools-types ![GitHub Repo stars](https://img.shields.io/github/stars/rse/graphql-tools-types) ![GitHub last commit](https://img.shields.io/github/last-commit/rse/graphql-tools-types)](https://github.com/rse/graphql-tools-types) - Custom GraphQL types for use with GraphQL-Tools (Void, Int, Float, String, Date, UUID, JSON)
...
* [graphql-pouch ![GitHub Repo stars](https://img.shields.io/github/stars/MikeBild/graphql-pouch) ![GitHub last commit](https://img.shields.io/github/last-commit/MikeBild/graphql-pouch)](https://github.com/MikeBild/graphql-pouch) - A GraphQL-API runtime on top of PouchDB created by GraphQL shorthand notation as a self contained service with CouchDB synchronization.
* [gql-tools ![GitHub Repo stars](https://img.shields.io/github/stars/almilo/gql-tools) ![GitHub last commit](https://img.shields.io/github/last-commit/almilo/gql-tools)](https://github.com/almilo/gql-tools) - Tool library with CLI for schema generation and manipulation.
* [graphql-iso-date ![GitHub Repo stars](https://img.shields.io/github/stars/excitement-engineer/graphql-iso-date) ![GitHub last commit](https://img.shields.io/github/last-commit/excitement-engineer/graphql-iso-date)](https://github.com/excitement-engineer/graphql-iso-date) - A GraphQL date scalar type to be used with GraphQL.js. This scalar represents a date in the ISO 8601 format YYYY-MM-DD.
...
* [GraphQL Scalars ![GitHub Repo stars](https://img.shields.io/github/stars/Urigo/graphql-scalars) ![GitHub last commit](https://img.shields.io/github/last-commit/Urigo/graphql-scalars)](https://github.com/Urigo/graphql-scalars): A library of custom GraphQL scalar types for creating precise, type-safe GraphQL schemas.
...
* [recompose-relay ![GitHub Repo stars](https://img.shields.io/github/stars/acdlite/recompose) ![GitHub last commit](https://img.shields.io/github/last-commit/acdlite/recompose)](https://github.com/acdlite/recompose/tree/master/src/packages/recompose-relay) - Recompose helpers for Relay.
* [Graylay ![GitHub Repo stars](https://img.shields.io/github/stars/larsbs/graysql) ![GitHub last commit](https://img.shields.io/github/last-commit/larsbs/graysql)](https://github.com/larsbs/graysql#Graylay) - A GraysQL extension to create a Relay compatible Schema.
* [react-relay-network-layer ![GitHub Repo stars](https://img.shields.io/github/stars/relay-tools/react-relay-network-layer) ![GitHub last commit](https://img.shields.io/github/last-commit/relay-tools/react-relay-network-layer)](https://github.com/relay-tools/react-relay-network-layer) - A network layer for Relay with query batching and middleware support (urlThunk, retryThunk, auth, defer and other).
* [relay-subscriptions ![GitHub Repo stars](https://img.shields.io/github/stars/relay-tools/relay-subscriptions) ![GitHub last commit](https://img.shields.io/github/last-commit/relay-tools/relay-subscriptions)](https://github.com/relay-tools/relay-subscriptions) - Subscription support for Relay.
* [Portfolio Relay Example ![GitHub Repo stars](https://img.shields.io/github/stars/alex-cory/portfolio) ![GitHub last commit](https://img.shields.io/github/last-commit/alex-cory/portfolio)](https://github.com/alex-cory/portfolio) - An example website that fetches data from various apis and uses Relay and GraphQL to feed the data to React components!
...
* [Railt ![GitHub Repo stars](https://img.shields.io/github/stars/railt/railt) ![GitHub last commit](https://img.shields.io/github/last-commit/railt/railt)](https://github.com/railt/railt) - High quality and loosely coupled framework for developing GraphQL applications using all the modern qualities of the language.
* [digiaonline ![GitHub Repo stars](https://img.shields.io/github/stars/digiaonline/graphql-php) ![GitHub last commit](https://img.shields.io/github/last-commit/digiaonline/graphql-php)](https://github.com/digiaonline/graphql-php) - Yet another PHP port of GraphQL reference implementation.
* [GraphQL ![GitHub Repo stars](https://img.shields.io/github/stars/youshido-php/GraphQL) ![GitHub last commit](https://img.shields.io/github/last-commit/youshido-php/GraphQL)](https://github.com/youshido-php/GraphQL) (*abandoned*) - Well documented PHP implementation with no dependencies.
...
* [laravel-graphql ![GitHub Repo stars](https://img.shields.io/github/stars/folkloreinc/laravel-graphql) ![GitHub last commit](https://img.shields.io/github/last-commit/folkloreinc/laravel-graphql)](https://github.com/folkloreinc/laravel-graphql) (*abandoned*) - Facebook GraphQL for Laravel 5.
* [laravel-graphql-relay ![GitHub Repo stars](https://img.shields.io/github/stars/nuwave/laravel-graphql-relay) ![GitHub last commit](https://img.shields.io/github/last-commit/nuwave/laravel-graphql-relay)](https://github.com/nuwave/laravel-graphql-relay) - A Laravel library to help construct a server supporting react-relay.
* [graphql-mapper ![GitHub Repo stars](https://img.shields.io/github/stars/4rthem/graphql-mapper) ![GitHub last commit](https://img.shields.io/github/last-commit/4rthem/graphql-mapper)](https://github.com/4rthem/graphql-mapper) (*abandoned*) - This library allows to build a GraphQL schema based on your model.
* [graphql-bundle ![GitHub Repo stars](https://img.shields.io/github/stars/hoticeking/GraphQLBundle) ![GitHub last commit](https://img.shields.io/github/last-commit/hoticeking/GraphQLBundle)](https://github.com/hoticeking/GraphQLBundle) - GraphQL Bundle for Symfony 2.
...
* [GraphQL Symfony Bundle ![GitHub Repo stars](https://img.shields.io/github/stars/youshido-php/GraphQLBundle) ![GitHub last commit](https://img.shields.io/github/last-commit/youshido-php/GraphQLBundle)](https://github.com/youshido-php/GraphQLBundle) - GraphQL Bundle for the Symfony 3 (supports 2.6+).
* [graphql-wp ![GitHub Repo stars](https://img.shields.io/github/stars/tim-field/graphql-wp) ![GitHub last commit](https://img.shields.io/github/last-commit/tim-field/graphql-wp)](https://github.com/tim-field/graphql-wp) - WordPress plugin that exposes a GraphQL endpoint.
...
* [GraphQL Middleware ![GitHub Repo stars](https://img.shields.io/github/stars/stefanorg/graphql-middleware) ![GitHub last commit](https://img.shields.io/github/last-commit/stefanorg/graphql-middleware)](https://github.com/stefanorg/graphql-middleware) - GraphQL Psr7 Middleware
* [Zend Expressive GraphiQL Extension ![GitHub Repo stars](https://img.shields.io/github/stars/stefanorg/zend-expressive-graphiql) ![GitHub last commit](https://img.shields.io/github/last-commit/stefanorg/zend-expressive-graphiql)](https://github.com/stefanorg/zend-expressive-graphiql) - GraphiQL extension for zend expressive
...
* [GraPHPinator ![GitHub Repo stars](https://img.shields.io/github/stars/infinityloop-dev/graphpinator) ![GitHub last commit](https://img.shields.io/github/last-commit/infinityloop-dev/graphpinator)](https://github.com/infinityloop-dev/graphpinator) - Easy-to-use GraphQL server implementation for modern PHP.
...
* [graphql-core ![GitHub Repo stars](https://img.shields.io/github/stars/graphql-python/graphql-core) ![GitHub last commit](https://img.shields.io/github/last-commit/graphql-python/graphql-core)](https://github.com/graphql-python/graphql-core) - GraphQL implementation for Python based on GraphQL.js v0.6.0 reference implementation
* [graphql-core-next ![GitHub Repo stars](https://img.shields.io/github/stars/graphql-python/graphql-core-next) ![GitHub last commit](https://img.shields.io/github/last-commit/graphql-python/graphql-core-next)](https://github.com/graphql-python/graphql-core-next) - Latest GraphQL implementation based on GraphQL.js v14.5.6 reference implementation
...
* [machinebox/graphql ![GitHub Repo stars](https://img.shields.io/github/stars/machinebox/graphql) ![GitHub last commit](https://img.shields.io/github/last-commit/machinebox/graphql)](https://github.com/machinebox/graphql) - Simple low-level GraphQL client for Go
...
* [graphql ![GitHub Repo stars](https://img.shields.io/github/stars/tmc/graphql) ![GitHub last commit](https://img.shields.io/github/last-commit/tmc/graphql)](https://github.com/tmc/graphql) - GraphQL parser and server for Go.
* [c-graphqlparser ![GitHub Repo stars](https://img.shields.io/github/stars/tecbot/c-graphqlparser) ![GitHub last commit](https://img.shields.io/github/last-commit/tecbot/c-graphqlparser)](https://github.com/tecbot/c-graphqlparser) - Go-gettable version of the libgraphqlparser C library for parsing GraphQL.
* [tallstreet-graphql ![GitHub Repo stars](https://img.shields.io/github/stars/tallstreet/graphql) ![GitHub last commit](https://img.shields.io/github/last-commit/tallstreet/graphql)](https://github.com/tallstreet/graphql) - GraphQL parser and server for Go that leverages libgraphqlparser
* [go-graphql ![GitHub Repo stars](https://img.shields.io/github/stars/playlyfe/go-graphql) ![GitHub last commit](https://img.shields.io/github/last-commit/playlyfe/go-graphql)](https://github.com/playlyfe/go-graphql) - A powerful GraphQL server implementation for Golang
...
* [graphql-scala ![GitHub Repo stars](https://img.shields.io/github/stars/hrosenhorn/graphql-scala) ![GitHub last commit](https://img.shields.io/github/last-commit/hrosenhorn/graphql-scala)](https://github.com/hrosenhorn/graphql-scala) - An attempt to get GraphQL going with Scala.
...
### Dart Libraries
* [Angel GraphQL ![GitHub Repo stars](https://img.shields.io/github/stars/angel-dart/graphql) ![GitHub last commit](https://img.shields.io/github/last-commit/angel-dart/graphql)](https://github.com/angel-dart/graphql) - GraphQL server implementation with bindings
...
* [juniper ![GitHub Repo stars](https://img.shields.io/github/stars/mhallin/juniper) ![GitHub last commit](https://img.shields.io/github/last-commit/mhallin/juniper)](https://github.com/mhallin/juniper) - GraphQL server library for Rust.
...
* [GraphiQL.app ![GitHub Repo stars](https://img.shields.io/github/stars/skevy/graphiql-app) ![GitHub last commit](https://img.shields.io/github/last-commit/skevy/graphiql-app)](https://github.com/skevy/graphiql-app) - A light, Electron-based wrapper around GraphiQL.
* [GraphQLviz ![GitHub Repo stars](https://img.shields.io/github/stars/Macroz/GraphQLviz) ![GitHub last commit](https://img.shields.io/github/last-commit/Macroz/GraphQLviz)](https://github.com/Macroz/GraphQLviz) - GraphQLviz marries GraphQL (schemas) with Graphviz.
* [graphqlviz ![GitHub Repo stars](https://img.shields.io/github/stars/sheerun/graphqlviz) ![GitHub last commit](https://img.shields.io/github/last-commit/sheerun/graphqlviz)](https://github.com/sheerun/graphqlviz) - GraphQL API visualizer in Node.js
...
* [gdom ![GitHub Repo stars](https://img.shields.io/github/stars/syrusakbary/gdom) ![GitHub last commit](https://img.shields.io/github/last-commit/syrusakbary/gdom)](https://github.com/syrusakbary/gdom) - DOM Traversing and Scraping using GraphQL.
* [Annotated GraphQL Server ![GitHub Repo stars](https://img.shields.io/github/stars/almilo/annotated-graphql-server) ![GitHub last commit](https://img.shields.io/github/last-commit/almilo/annotated-graphql-server)](https://github.com/almilo/annotated-graphql-server) - Server for annotated GraphQL showing how to transform a REST api into a GraphQL endpoint with annotations.
...
* [GraphQL Network ![GitHub Repo stars](https://img.shields.io/github/stars/Ghirro/graphql-network) ![GitHub last commit](https://img.shields.io/github/last-commit/Ghirro/graphql-network)](https://github.com/Ghirro/graphql-network) - A chrome dev-tools extension for debugging GraphQL network requests.
...
* [GraphQL CMS ![GitHub Repo stars](https://img.shields.io/github/stars/sarkistlt/graphql-auto-generating-cms) ![GitHub last commit](https://img.shields.io/github/last-commit/sarkistlt/graphql-auto-generating-cms)](https://github.com/sarkistlt/graphql-auto-generating-cms) - Use your existing GraphQL schema to generate simple for use, fully functional CMS in a couple steps.
...
* [GraphQL IDE ![GitHub Repo stars](https://img.shields.io/github/stars/andev-software/graphql-ide) ![GitHub last commit](https://img.shields.io/github/last-commit/andev-software/graphql-ide)](https://github.com/andev-software/graphql-ide) - An extensive IDE for exploring GraphQL API's.
...
* [Altair GraphQL Client ![GitHub Repo stars](https://img.shields.io/github/stars/imolorhe/altair) ![GitHub last commit](https://img.shields.io/github/last-commit/imolorhe/altair)](https://github.com/imolorhe/altair) - A beautiful feature-rich GraphQL Client for all platforms.
...
* [graphql-typed-client ![GitHub Repo stars](https://img.shields.io/github/stars/helios1138/graphql-typed-client) ![GitHub last commit](https://img.shields.io/github/last-commit/helios1138/graphql-typed-client)](https://github.com/helios1138/graphql-typed-client) - A tool that generates a strongly typed client library for any GraphQL endpoint.  The client allows writing GraphQL queries as plain JS objects (with type safety and awesome code completion experience)
...
* [SwitchQL ![GitHub Repo stars](https://img.shields.io/github/stars/SwitchQL/SwitchQL) ![GitHub last commit](https://img.shields.io/github/last-commit/SwitchQL/SwitchQL)](https://github.com/SwitchQL/SwitchQL) - Automated transcription of database schemas into GraphQL schemas, resolvers, queries, and mutations
...
* [GraphQL '98 ![GitHub Repo stars](https://img.shields.io/github/stars/marcello3d/graphql-98) ![GitHub last commit](https://img.shields.io/github/last-commit/marcello3d/graphql-98)](https://github.com/marcello3d/graphql-98) - A visual GraphQL data browser, like a SQL GUI for GraphQL
...
* [Weaviate ![GitHub Repo stars](https://img.shields.io/github/stars/semi-technologies/weaviate) ![GitHub last commit](https://img.shields.io/github/last-commit/semi-technologies/weaviate)](https://github.com/semi-technologies/weaviate) - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://www.semi.technology/developers/weaviate/current/graphql-references/) built to scale your machine learning models.
...
* [graphql-aws ![GitHub Repo stars](https://img.shields.io/github/stars/jonsharratt/graphql-aws) ![GitHub last commit](https://img.shields.io/github/last-commit/jonsharratt/graphql-aws)](https://github.com/jonsharratt/graphql-aws) - Amazon AWS GraphQL API Server.
* [graffiti-todo ![GitHub Repo stars](https://img.shields.io/github/stars/RisingStack/graffiti-todo) ![GitHub last commit](https://img.shields.io/github/last-commit/RisingStack/graffiti-todo)](https://github.com/RisingStack/graffiti-todo) - Example Relay TodoMVC application using graffiti-mongoose.  **WARNING** Graffiti is no longer actively maintained.  For hobbyist only.
* [devknoll/gist:8b274f1c5d05230bfade](https://gist.github.com/devknoll/8b274f1c5d05230bfade)
* [UniversalRelayBoilerplate ![GitHub Repo stars](https://img.shields.io/github/stars/MachineAcuity/rebar) ![GitHub last commit](https://img.shields.io/github/last-commit/MachineAcuity/rebar)](https://github.com/MachineAcuity/rebar)
...
* [koa-graphql-relay-example ![GitHub Repo stars](https://img.shields.io/github/stars/chentsulin/koa-graphql-relay-example) ![GitHub last commit](https://img.shields.io/github/last-commit/chentsulin/koa-graphql-relay-example)](https://github.com/chentsulin/koa-graphql-relay-example) - Example of [koa-graphql ![GitHub Repo stars](https://img.shields.io/github/stars/chentsulin/koa-graphql) ![GitHub last commit](https://img.shields.io/github/last-commit/chentsulin/koa-graphql)](https://github.com/chentsulin/koa-graphql)
* [relay-fullstack ![GitHub Repo stars](https://img.shields.io/github/stars/lvarayut/relay-fullstack) ![GitHub last commit](https://img.shields.io/github/last-commit/lvarayut/relay-fullstack)](https://github.com/lvarayut/relay-fullstack) - Relay Starter Kit integrated with Relay, GraphQL, Express, ES6/ES7, JSX, Webpack, Babel, Material Design Lite, and PostCSS.
* [serverless-graphql-blog ![GitHub Repo stars](https://img.shields.io/github/stars/serverless/serverless-graphql-blog) ![GitHub last commit](https://img.shields.io/github/last-commit/serverless/serverless-graphql-blog)](https://github.com/serverless/serverless-graphql-blog) - A Serverless Blog leveraging GraphQL to offer a REST API with only 1 endpoint
* [relay-cart ![GitHub Repo stars](https://img.shields.io/github/stars/soonlive/relay-cart) ![GitHub last commit](https://img.shields.io/github/last-commit/soonlive/relay-cart)](https://github.com/soonlive/relay-cart) - A simple shopping cart example leveraging relay & GraphQL with routing and pagination.
* [graphql-loader ![GitHub Repo stars](https://img.shields.io/github/stars/applification/graphql-loader) ![GitHub last commit](https://img.shields.io/github/last-commit/applification/graphql-loader)](https://github.com/applification/graphql-loader) - Example project to illustrate GraphQL, Express and Facebook DataLoader to connect to third party REST API
* [swapi-graphql-lambda ![GitHub Repo stars](https://img.shields.io/github/stars/alvinthen/swapi-graphql-lambda) ![GitHub last commit](https://img.shields.io/github/last-commit/alvinthen/swapi-graphql-lambda)](https://github.com/alvinthen/swapi-graphql-lambda) - A GraphQL schema hosted in AWS Lambda wrapping swapi.co
...
* [f8-apollo ![GitHub Repo stars](https://img.shields.io/github/stars/nnance/f8app-apollo) ![GitHub last commit](https://img.shields.io/github/last-commit/nnance/f8app-apollo)](https://github.com/nnance/f8app-apollo) - Refactored version of the official F8 app of 2016, powered by React Native and the Apollo Stack.
* [f8app ![GitHub Repo stars](https://img.shields.io/github/stars/fbsamples/f8app) ![GitHub last commit](https://img.shields.io/github/last-commit/fbsamples/f8app)](https://github.com/fbsamples/f8app) - Source code of the official F8 app of 2016, powered by React Native and other Facebook open source projects. [makeitopen.com](https://makeitopen.com)
* [Reindex Examples ![GitHub Repo stars](https://img.shields.io/github/stars/reindexio/reindex-examples) ![GitHub last commit](https://img.shields.io/github/last-commit/reindexio/reindex-examples)](https://github.com/reindexio/reindex-examples) - Example projects for Reindex with using React Native and React.js for web.
* [Modelizr Documentation](https://julienvincent.io/modelizr/) - Documentation and Usage Examples for modelizr
* [Vue Apollo Example ![GitHub Repo stars](https://img.shields.io/github/stars/Akryum/frontpage-vue-app) ![GitHub last commit](https://img.shields.io/github/last-commit/Akryum/frontpage-vue-app)](https://github.com/Akryum/frontpage-vue-app) - Apollo example project for Vue 2.0.
* [angular2-graphql-rest ![GitHub Repo stars](https://img.shields.io/github/stars/kamilkisiela/angular2-graphql-rest) ![GitHub last commit](https://img.shields.io/github/last-commit/kamilkisiela/angular2-graphql-rest)](https://github.com/kamilkisiela/angular2-graphql-rest) - An example app with REST Api working side by side with GraphQL using Apollo Client with angular2-apollo. Includes step-by-step tutorial how to migrate from REST to GraphQL.
* [GraphQL-DataLoader-Boilerplate ![GitHub Repo stars](https://img.shields.io/github/stars/entria/graphql-dataloader-boilerplate) ![GitHub last commit](https://img.shields.io/github/last-commit/entria/graphql-dataloader-boilerplate)](https://github.com/entria/graphql-dataloader-boilerplate) - Boilerplate to start your GraphQL with DataLoader server
* [GraphQL-CEP ![GitHub Repo stars](https://img.shields.io/github/stars/sibelius/graphql-cep) ![GitHub last commit](https://img.shields.io/github/last-commit/sibelius/graphql-cep)](https://github.com/sibelius/graphql-cep) - Query address by CEP
...
* [Intuitive GraphQL Resolver Example ![GitHub Repo stars](https://img.shields.io/github/stars/xpepermint/graphql-example) ![GitHub last commit](https://img.shields.io/github/last-commit/xpepermint/graphql-example)](https://github.com/xpepermint/graphql-example) - GraphQL application example using [contextable.js ![GitHub Repo stars](https://img.shields.io/github/stars/rawmodel/framework) ![GitHub last commit](https://img.shields.io/github/last-commit/rawmodel/framework)](https://github.com/rawmodel/framework).
...
* [hello_graphql_phoenix ![GitHub Repo stars](https://img.shields.io/github/stars/graphql-elixir/hello_graphql_phoenix) ![GitHub last commit](https://img.shields.io/github/last-commit/graphql-elixir/hello_graphql_phoenix)](https://github.com/graphql-elixir/hello_graphql_phoenix) - Examples of GraphQL Elixir Plug endpoints mounted in Phoenix - [View demo online](http://playground.graphql-elixir.org).
...
* [siler-graphgl ![GitHub Repo stars](https://img.shields.io/github/stars/leocavalcante/siler) ![GitHub last commit](https://img.shields.io/github/last-commit/leocavalcante/siler)](https://github.com/leocavalcante/siler/tree/master/examples/graphql) - An example GraphQL server written with Siler
