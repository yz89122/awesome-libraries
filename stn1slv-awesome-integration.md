...
- [OpenAPI Diff ![GitHub Repo stars](https://img.shields.io/github/stars/OpenAPITools/openapi-diff) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenAPITools/openapi-diff)](https://github.com/OpenAPITools/openapi-diff) - Compare two OpenAPI specifications (3.x) and render the difference to HTML plaintext, or Markdown files.
- [OpenAPI Generator ![GitHub Repo stars](https://img.shields.io/github/stars/OpenAPITools/openapi-generator) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenAPITools/openapi-generator)](https://github.com/OpenAPITools/openapi-generator) - Allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (both 2.0 and 3.0 are supported).
- [OpenAPI Style Validator ![GitHub Repo stars](https://img.shields.io/github/stars/OpenAPITools/openapi-style-validator) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenAPITools/openapi-style-validator)](https://github.com/OpenAPITools/openapi-style-validator) - A customizable style validator to make sure your OpenAPI spec follows your organization's standards.
...
- [Zally ![GitHub Repo stars](https://img.shields.io/github/stars/zalando/zally) ![GitHub last commit](https://img.shields.io/github/last-commit/zalando/zally)](https://github.com/zalando/zally) - A linter for OpenAPI specifications.
...
- [Goku API Gateway ![GitHub Repo stars](https://img.shields.io/github/stars/eolinker/goku) ![GitHub last commit](https://img.shields.io/github/last-commit/eolinker/goku)](https://github.com/eolinker/goku) - Golang-based microservice gateway that enables high-performance dynamic routing,service orchestration, multi-tenancy management, API access control, etc.
- [Kong API Gateway ![GitHub Repo stars](https://img.shields.io/github/stars/Kong/kong) ![GitHub last commit](https://img.shields.io/github/last-commit/Kong/kong)](https://github.com/Kong/kong) - Cloud-native, platform-agnostic, scalable API Gateway distinguished for its high performance and extensibility via plugins.
- [KrakenD API Gateway ![GitHub Repo stars](https://img.shields.io/github/stars/devopsfaith/krakend-ce) ![GitHub last commit](https://img.shields.io/github/last-commit/devopsfaith/krakend-ce)](https://github.com/devopsfaith/krakend-ce) - Ultra-High performance API Gateway with middlewares.
- [Ocelot ![GitHub Repo stars](https://img.shields.io/github/stars/ThreeMammals/Ocelot) ![GitHub last commit](https://img.shields.io/github/last-commit/ThreeMammals/Ocelot)](https://github.com/ThreeMammals/Ocelot) - .NET API Gateway.
...
- [Tyk API Gateway ![GitHub Repo stars](https://img.shields.io/github/stars/TykTechnologies/tyk) ![GitHub last commit](https://img.shields.io/github/last-commit/TykTechnologies/tyk)](https://github.com/TykTechnologies/tyk) - An open source Enterprise API Gateway, supporting REST, GraphQL, TCP and gRPC protocols.

### API Testing
*API testing tools.*
- API clients
  - [curl ![GitHub Repo stars](https://img.shields.io/github/stars/curl/curl) ![GitHub last commit](https://img.shields.io/github/last-commit/curl/curl)](https://github.com/curl/curl) - Command line tool and library for transferring data with URLs.
...
- MQ clients
  - [JMSToolBox ![GitHub Repo stars](https://img.shields.io/github/stars/jmstoolbox/jmstoolbox) ![GitHub last commit](https://img.shields.io/github/last-commit/jmstoolbox/jmstoolbox)](https://github.com/jmstoolbox/jmstoolbox) - An universal JMS Client able to interact with the greatest number of JMS based message brokers.
  - [kcat ![GitHub Repo stars](https://img.shields.io/github/stars/edenhill/kcat) ![GitHub last commit](https://img.shields.io/github/last-commit/edenhill/kcat)](https://github.com/edenhill/kcat) - A generic non-JVM producer and consumer for Apache Kafka, think of it as a netcat for Kafka. Formerly known as kafkacat.
...
- Mocking tools
  - [Microcks ![GitHub Repo stars](https://img.shields.io/github/stars/microcks/microcks) ![GitHub last commit](https://img.shields.io/github/last-commit/microcks/microcks)](https://github.com/microcks/microcks) - Open source Kubernetes Native tool for API Mocking and Testing. Supports AsyncAPI, OpenAPI, Postman Collections etc.
  ...
  - [MockServer ![GitHub Repo stars](https://img.shields.io/github/stars/mock-server/mockserver) ![GitHub last commit](https://img.shields.io/github/last-commit/mock-server/mockserver)](https://github.com/mock-server/mockserver) - Easy mocking of any system you integrate with via HTTP or HTTPS.
  - [Mocky](https://designer.mocky.io/) - A free and unlimited online service which allows to generate custom HTTP responses.
  - [Prism ![GitHub Repo stars](https://img.shields.io/github/stars/stoplightio/prism) ![GitHub last commit](https://img.shields.io/github/last-commit/stoplightio/prism)](https://github.com/stoplightio/prism) - An open-source HTTP mock server that can mimic your API`s behavior as if you already built it.
  - [WireMock ![GitHub Repo stars](https://img.shields.io/github/stars/tomakehurst/wiremock) ![GitHub last commit](https://img.shields.io/github/last-commit/tomakehurst/wiremock)](https://github.com/tomakehurst/wiremock) - Mock your APIs for fast, robust and comprehensive testing.
- Testing tools and frameworks
  - [Apache JMeter](https://jmeter.apache.org/) - An open source java based load testing tool.
  - [Karate ![GitHub Repo stars](https://img.shields.io/github/stars/intuit/karate) ![GitHub last commit](https://img.shields.io/github/last-commit/intuit/karate)](https://github.com/intuit/karate) - Open-source tool to combine API test-automation, mocks, performance-testing and even UI automation into a single, unified framework.
...
- [Easy Rules ![GitHub Repo stars](https://img.shields.io/github/stars/j-easy/easy-rules) ![GitHub last commit](https://img.shields.io/github/last-commit/j-easy/easy-rules)](https://github.com/j-easy/easy-rules) - A simple Java rules engine.
- [NxBRE ![GitHub Repo stars](https://img.shields.io/github/stars/ddossot/NxBRE) ![GitHub last commit](https://img.shields.io/github/last-commit/ddossot/NxBRE)](https://github.com/ddossot/NxBRE/wiki) - Open-source rule engine for the .NET platform.
...
- [Activiti ![GitHub Repo stars](https://img.shields.io/github/stars/Activiti/Activiti) ![GitHub last commit](https://img.shields.io/github/last-commit/Activiti/Activiti)](https://github.com/Activiti/Activiti) - A lightweight and java-centric open-source BPMN engine.
- [Apache Airflow ![GitHub Repo stars](https://img.shields.io/github/stars/apache/airflow) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/airflow)](https://github.com/apache/airflow) - A platform to programmatically author, schedule, and monitor workflows.
- [Argo Workflows ![GitHub Repo stars](https://img.shields.io/github/stars/argoproj/argo-workflows) ![GitHub last commit](https://img.shields.io/github/last-commit/argoproj/argo-workflows)](https://github.com/argoproj/argo-workflows) -  An open source container-native workflow engine for orchestrating parallel jobs on Kubernetes.
- [Azkaban ![GitHub Repo stars](https://img.shields.io/github/stars/azkaban/azkaban) ![GitHub last commit](https://img.shields.io/github/last-commit/azkaban/azkaban)](https://github.com/azkaban/azkaban) - A distributed Workflow Manager, implemented at LinkedIn to solve the problem of Hadoop job dependencies.
- [Bonita ![GitHub Repo stars](https://img.shields.io/github/stars/bonitasoft/bonita-engine) ![GitHub last commit](https://img.shields.io/github/last-commit/bonitasoft/bonita-engine)](https://github.com/bonitasoft/bonita-engine) - BPMN engine that comes with an optional development environment, a designer, an optional user interface and administrative tools.
- [Cadence ![GitHub Repo stars](https://img.shields.io/github/stars/uber/cadence) ![GitHub last commit](https://img.shields.io/github/last-commit/uber/cadence)](https://github.com/uber/cadence) - Fault-Tolerant Stateful Code Platform.
- [Camunda ![GitHub Repo stars](https://img.shields.io/github/stars/camunda/camunda-bpm-platform) ![GitHub last commit](https://img.shields.io/github/last-commit/camunda/camunda-bpm-platform)](https://github.com/camunda/camunda-bpm-platform) - An open-source workflow and decision automation platform.
- [Conductor ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/conductor) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/conductor)](https://github.com/Netflix/conductor) - Netflix Conductor is an orchestration engine that runs in the cloud.
- [Elsa Core ![GitHub Repo stars](https://img.shields.io/github/stars/elsa-workflows/elsa-core) ![GitHub last commit](https://img.shields.io/github/last-commit/elsa-workflows/elsa-core)](https://github.com/elsa-workflows/elsa-core) -  A workflows library that enables workflow execution in any .NET Core application.
- [Flowable ![GitHub Repo stars](https://img.shields.io/github/stars/flowable/flowable-engine) ![GitHub last commit](https://img.shields.io/github/last-commit/flowable/flowable-engine)](https://github.com/flowable/flowable-engine) - Provides a core set of open source business process engines that are compact and highly efficient.
- [jBPM](https://www.jbpm.org/) - A toolkit for building business applications to help automate business processes and decisions.
- [StackStorm ![GitHub Repo stars](https://img.shields.io/github/stars/StackStorm/st2) ![GitHub last commit](https://img.shields.io/github/last-commit/StackStorm/st2)](https://github.com/StackStorm/st2) - Robust Automation Engine providing Sensors, Triggers, Rules, Workflows, and Actions. StackStorm is how you “glue” your applications together.
...
- [GraphQL ![GitHub Repo stars](https://img.shields.io/github/stars/graphql/graphql-spec) ![GitHub last commit](https://img.shields.io/github/last-commit/graphql/graphql-spec)](https://github.com/graphql/graphql-spec) - A query language for APIs and a runtime for fulfilling those queries with your existing data.
...
- [RAML ![GitHub Repo stars](https://img.shields.io/github/stars/raml-org/raml-spec) ![GitHub last commit](https://img.shields.io/github/last-commit/raml-org/raml-spec)](https://github.com/raml-org/raml-spec/blob/master/versions/raml-10/raml-10.md/) - RESTful API Modeling Language.
...
### Data Formats
- [Apache Avro ![GitHub Repo stars](https://img.shields.io/github/stars/apache/avro) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/avro)](https://github.com/apache/avro) - Data serialization system.
...
- [NDJSON ![GitHub Repo stars](https://img.shields.io/github/stars/ndjson/ndjson-spec) ![GitHub last commit](https://img.shields.io/github/last-commit/ndjson/ndjson-spec)](https://github.com/ndjson/ndjson-spec) - A standard for delimiting JSON in stream protocols.
