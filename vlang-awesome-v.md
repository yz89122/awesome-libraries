...
- [Heroku Buildpack for V ![GitHub Repo stars](https://img.shields.io/github/stars/louis77/heroku-buildpack-v) ![GitHub last commit](https://img.shields.io/github/last-commit/louis77/heroku-buildpack-v)](https://github.com/louis77/heroku-buildpack-v) - Deploy V apps on Heroku.
...
- [flappylearning-v ![GitHub Repo stars](https://img.shields.io/github/stars/uxnow/flappylearning-v) ![GitHub last commit](https://img.shields.io/github/last-commit/uxnow/flappylearning-v)](https://github.com/uxnow/flappylearning-v) - A simple flappy learning demo in v. ( Archived )
...
- [vgl ![GitHub Repo stars](https://img.shields.io/github/stars/justicesuh/vgl) ![GitHub last commit](https://img.shields.io/github/last-commit/justicesuh/vgl)](https://github.com/justicesuh/vgl) - Low-level graphics API access.
...
- [vsl ![GitHub Repo stars](https://img.shields.io/github/stars/vlang/vsl) ![GitHub last commit](https://img.shields.io/github/last-commit/vlang/vsl)](https://github.com/vlang/vsl) - A pure-V scientific library with a great variety of functions.
- [vtl ![GitHub Repo stars](https://img.shields.io/github/stars/vlang/vtl) ![GitHub last commit](https://img.shields.io/github/last-commit/vlang/vtl)](https://github.com/vlang/vtl) - Numerical computing library supporting n-dimensional data structure, backed by LAPACKE and OpenBLAS.
...
- [random ![GitHub Repo stars](https://img.shields.io/github/stars/Delta456/random) ![GitHub last commit](https://img.shields.io/github/last-commit/Delta456/random)](https://github.com/Delta456/random) - An all purpose random library written in V.
...
- [vscode-vlang ![GitHub Repo stars](https://img.shields.io/github/stars/0x9ef/vscode-vlang) ![GitHub last commit](https://img.shields.io/github/last-commit/0x9ef/vscode-vlang)](https://github.com/0x9ef/vscode-vlang) - V Language extension for Visual Studio Code.
...
- [setup-v-action ![GitHub Repo stars](https://img.shields.io/github/stars/marketplace/actions) ![GitHub last commit](https://img.shields.io/github/last-commit/marketplace/actions)](https://github.com/marketplace/actions/setup-v-environment) - GitHub action automation to use V in your workflow.
...
- [Rosetta Code V ![GitHub Repo stars](https://img.shields.io/github/stars/RustemB/rosetta-code-v) ![GitHub last commit](https://img.shields.io/github/last-commit/RustemB/rosetta-code-v)](https://github.com/RustemB/rosetta-code-v) - Solutions for Rosetta Code in V.
...
- [The Book of V ![GitHub Repo stars](https://img.shields.io/github/stars/KeyWeeUsr/the-book-of-v) ![GitHub last commit](https://img.shields.io/github/last-commit/KeyWeeUsr/the-book-of-v)](https://github.com/KeyWeeUsr/the-book-of-v/)
