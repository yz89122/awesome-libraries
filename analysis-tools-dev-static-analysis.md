...
- [VSDiagnostics ![GitHub Repo stars](https://img.shields.io/github/stars/Vannevelj/VSDiagnostics) ![GitHub last commit](https://img.shields.io/github/last-commit/Vannevelj/VSDiagnostics)](https://github.com/Vannevelj/VSDiagnostics) - A collection of static analyzers based on Roslyn that integrates with VS.
...
- [dingo-hunter ![GitHub Repo stars](https://img.shields.io/github/stars/nickng/dingo-hunter) ![GitHub last commit](https://img.shields.io/github/last-commit/nickng/dingo-hunter)](https://github.com/nickng/dingo-hunter) - Static analyser for finding deadlocks in Go.
...
- [luacheck ![GitHub Repo stars](https://img.shields.io/github/stars/mpeterv/luacheck) ![GitHub last commit](https://img.shields.io/github/last-commit/mpeterv/luacheck)](https://github.com/mpeterv/luacheck) - A tool for linting and static analysis of Lua code.
...
- [Qafoo Quality Analyzer ![GitHub Repo stars](https://img.shields.io/github/stars/Qafoo/QualityAnalyzer) ![GitHub last commit](https://img.shields.io/github/last-commit/Qafoo/QualityAnalyzer)](https://github.com/Qafoo/QualityAnalyzer) - Visualizes metrics and source code.
