...
## Companies with "remote DNA"
  ...
  18. [Sourcegraph ![GitHub Repo stars](https://img.shields.io/github/stars/sourcegraph/careers) ![GitHub last commit](https://img.shields.io/github/last-commit/sourcegraph/careers)](https://github.com/sourcegraph/careers) - Code search and navigation for teams (self-hosted, OSS). Fully remote (across time zones).
