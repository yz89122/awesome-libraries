...
* [polyglot ![GitHub Repo stars](https://img.shields.io/github/stars/agkozak/polyglot) ![GitHub last commit](https://img.shields.io/github/last-commit/agkozak/polyglot)](https://github.com/agkozak/polyglot) - An informative Git prompt that works in bash, zsh, ksh, mksh, pdksh, dash, and busybox sh
...
* [bpytop ![GitHub Repo stars](https://img.shields.io/github/stars/aristocratos/bpytop) ![GitHub last commit](https://img.shields.io/github/last-commit/aristocratos/bpytop)](https://github.com/aristocratos/bpytop) - Linux/OSX/FreeBSD resource monitor
