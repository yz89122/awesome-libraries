...
[<img src="https://github.com/coq-community/awesome-coq/raw/master/coq-logo.svg" align="right" width="100" title="Awesome Coq is a coq-community project"> ![GitHub Repo stars](https://img.shields.io/github/stars/coq-community/manifesto) ![GitHub last commit](https://img.shields.io/github/last-commit/coq-community/manifesto)](https://github.com/coq-community/manifesto)
...
- [jsCoq ![GitHub Repo stars](https://img.shields.io/github/stars/ejgallego/jscoq) ![GitHub last commit](https://img.shields.io/github/last-commit/ejgallego/jscoq)](https://github.com/ejgallego/jscoq) - Port of Coq to JavaScript, which enables running Coq projects in a browser.
...
- [VSCoq ![GitHub Repo stars](https://img.shields.io/github/stars/coq-community/vscoq) ![GitHub last commit](https://img.shields.io/github/last-commit/coq-community/vscoq)](https://github.com/coq-community/vscoq) - Extension for the Visual Studio Code editor.
...
- [coq-dpdgraph ![GitHub Repo stars](https://img.shields.io/github/stars/Karmaki/coq-dpdgraph) ![GitHub last commit](https://img.shields.io/github/last-commit/Karmaki/coq-dpdgraph)](https://github.com/Karmaki/coq-dpdgraph) - Tool for building dependency graphs between Coq objects.
